...
def main():
    ...
    AnonymousTalk(    #296
        "\x07\x00交出了\x07\x02给工房长的介绍信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #407
        "\x07\x00得到了\x07\x02汽油罐\x07\x00。\x02",
    )
