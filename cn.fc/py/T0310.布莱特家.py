...
def main():
    ...
    AnonymousTalk(    #36
        "\x07\x00得到了\x07\x04５００\x07\x00米拉。\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #45
        "\x07\x00交出了\x07\x02利贝尔通讯\x07\x00和\x07\x02致卡西乌斯的信\x07\x00。\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #117
        "\x07\x05卡西乌斯将抱在手里的毛毯掀开。\x07\x00\x02",
    )
