...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00里面放着\x07\x02哈茨少年冒险记·下\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #3
        "\x07\x00得到了\x07\x02苍耀石护符\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #4
        (
            "宝箱里装有\x07\x02苍耀石护符\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02苍耀石护符\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #7
        "\x07\x00得到了\x07\x02长桶\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #8
        (
            "宝箱里装有\x07\x02长桶\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02长桶\x07\x00不能再拿更多了。\x02",
        )
    )
