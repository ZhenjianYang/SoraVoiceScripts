...
def main():
    ...
    AnonymousTalk(    #13
        "\x07\x00交出了\x07\x02游击士协会的介绍信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #114
        "\x07\x05艾丝蒂尔告诉伊莉莎她和约修亚将要去柏斯。\x02",
    )
    ...
    AnonymousTalk(    #222
        "\x06\x07\x00尝了尝\x07\x02一口气薏粉\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #223
        "\x06\x07\x00学会了\x07\x02一口气薏粉\x07\x00的做法。\x02",
    )
