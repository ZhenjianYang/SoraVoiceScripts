...
def main():
    ...
    AnonymousTalk(    #374
        (
            "\x07\x05※请在艾丝蒂尔的导力器的中心孔安装#90IＨＰ１，\x01",
            "在约修亚的导力器的中心孔安装#93I行动力１，\x01",
            "使两人分别获得回复魔法和攻击魔法吧。\x02",
        )
    )
    ...
    ChrTalk(    #387
        ...
        (
            ...
            "也是最适合个人使用的战斗工具。\x01",
            "\x07\x04持有者不同，其结构也会有所差异\x07\x00的哦。\x02",
        )
    )
    ...
    ChrTalk(    #391
        ...
        (
            "用来发动导力魔法的ＥＰ值上限，\x01",
            "\x07\x04会随着开封的结晶孔数增加\x07\x00而不断上升。\x01",
    ...
    ChrTalk(    #397
        ...
        (
            "可供使用的魔法\x01",
            "\x07\x04会依照安装在导力器里的\x01",
            "\x07\x00结晶回路的属性组合而变化。\x02",
        )
    )
    ...
    ChrTalk(    #401
        0x9,
        (
            "\x07\x04提升持有者各项能力\x07\x00的同时，\x01",
            "\x07\x04使其能够使用各种魔法\x07\x00是结晶回路最重要的作用。\x01",
    ...
    ChrTalk(    #403
        0x9,
        (
            "而根据结晶孔的不同，也有些\x07\x04只能安装\x01",
            "某种属性结晶回路\x07\x00的具有限定属性的结晶孔。\x02",
        )
    )
    ...
    ChrTalk(    #407
        ...
        (
            "虽说在王国每个城市里都有很多\x01",
            "\x07\x04可以把耀晶片换成流通货币米拉\x07\x00的店铺……\x02",
        )
    )
