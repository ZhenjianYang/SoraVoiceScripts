...
def main():
    ...
    AnonymousTalk(    #377
        "\x07\x00得到了\x07\x02给工房长的介绍信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #459
        "\x07\x05朵洛希把雷斯顿要塞的照片放在柜台上。\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #484
        "\x07\x00得到了\x07\x02朵洛希拍的照片\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #566
        "\x07\x00得到了\x07\x02雷斯顿要塞概略图\x07\x00。\x02",
    )
