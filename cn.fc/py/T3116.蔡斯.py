...
def main():
    ...
    AnonymousTalk(    #142
        "\x07\x00交出了\x07\x02内燃引擎设备\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #143
        "\x07\x00交出了\x07\x02汽油罐\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #162
        "\x07\x05艾丝蒂尔他们往黑色导力器外壳的表面上看去。\x02",
    )

    CloseMessageWindow()

    AnonymousTalk(    #163
        "\x07\x05外壳上只是留下了小小的伤口。\x02",
    )
    ...
    AnonymousTalk(    #214
        "\x07\x05艾丝蒂尔他们向阿加特说明了拉赛尔博士不见的事情。\x02",
    )
