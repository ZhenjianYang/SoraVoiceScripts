...
def main():
    ...
    AnonymousTalk(    #89
        "\x07\x00归还了\x07\x02结晶光学论集\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #90
        "\x07\x00归还了\x07\x02明日料理\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #91
        "\x07\x00归还了\x07\x02猫语日常会话入门\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #93
        "\x07\x02任务【募集临时图书馆员】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #173
        "\x07\x00归还了\x07\x02艾尔贝啄木鸟的生态\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #174
        "\x07\x02任务【临时图书馆员的加班】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #230
        "\x07\x00归还了\x07\x02哈茨少年冒险记·下\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #231
        "\x07\x02任务【续·临时图书馆员的加班】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #274
        "\x07\x00归还了\x07\x02３１棵丝柏树\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #275
        "\x07\x02任务【再续·临时图书管理员的加班】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #298
        "\x07\x00得到了\x07\x02结晶光学论集\x07\x00。\x02",
    )
