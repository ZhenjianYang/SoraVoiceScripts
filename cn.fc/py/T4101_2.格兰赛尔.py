...
def main():
    ...
    AnonymousTalk(    #31
        "\x07\x00得到了\x07\x02选手登记卡\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #56
        "\x07\x00得到两张\x07\x02观战门票\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #127
        "\x07\x00交出两张\x07\x02观战门票\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #391
        "\x07\x00得到了\x07\x02红耀石　第11卷\x07\x00。\x02",
    )
