...
def main():
    ...
    AnonymousTalk(    #0
        "\x06\x07\x00尝了尝\x07\x02健康泡饭\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #1
        "\x06\x07\x00学会了\x07\x02健康泡饭\x07\x00的做法。\x02",
    )
    ...
    AnonymousTalk(    #3
        "\x07\x00归还了\x07\x02钓鱼竿\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #10
        "\x07\x00借来了\x07\x02钓鱼竿\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #187
        "\x07\x00得到了\x07\x02亚瑟利亚葡萄酒\x07\x00。\x02",
    )
