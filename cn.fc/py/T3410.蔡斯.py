...
def main():
    ...
    AnonymousTalk(    #110
        "\x06\x07\x00尝了尝\x07\x02终极肉火锅\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #111
        "\x06\x07\x00学会了\x07\x02终极肉火锅\x07\x00的做法。\x02",
    )
    ...
    AnonymousTalk(    #480
        "\x07\x00里面放着\x07\x02３１棵丝柏树\x07\x00。\x02",
    )
