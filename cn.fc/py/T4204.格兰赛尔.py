...
def main():
    ...
    AnonymousTalk(    #48
        "\x07\x00交出了\x07\x02尤莉亚的介绍信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #211
        (
            "\x07\x05　　　　　　 　　 ～　关于通关存档的保存　～\x01",
            "　　 　　　　建立通关存档后，可以在标题画面中读取，\x01",
            "　　  　　　　 从而继承各项数据，开始二周目游戏。\x06\x18\x07\x00\x02",
        )
    )
