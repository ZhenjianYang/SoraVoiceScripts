...
def main():
    ...
    AnonymousTalk(    #25
        "\x07\x00得到了\x07\x02锁片薄衣\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #26
        (
            "宝箱里装有\x07\x02锁片薄衣\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02锁片薄衣\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #29
        "\x07\x00得到了\x07\x02翠耀石护符\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #30
        (
            "宝箱里装有\x07\x02翠耀石护符\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02翠耀石护符\x07\x00不能再拿更多了。\x02",
        )
    )
