...
def main():
    ...
    AnonymousTalk(    #5
        "\x07\x00交出了\x07\x02维修工具箱\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #18
        "\x07\x02任务【运送维修工具箱】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #22
        "\x07\x00交出了\x07\x02亚瑟利亚葡萄酒\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #26
        "\x07\x00交出了\x07\x02辣鳀鱼\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #42
        "\x07\x00得到了\x07\x02工作安全帽\x07\x00。\x02",
    )
