...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00得到了\x07\x02合金乌剑\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "宝箱里装有\x07\x02合金乌剑\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02合金乌剑\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #5
        "\x07\x00得到了\x07\x02女武神战甲\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "宝箱里装有\x07\x02女武神战甲\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02女武神战甲\x07\x00不能再拿更多了。\x02",
        )
    )
