...
def main():
    ...
    AnonymousTalk(    #8
        "\x07\x00交出了\x07\x02结晶回路的碎片\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #34
        "\x07\x00得到了５个\x07\x02肉馅丸子\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #45
        "\x07\x02任务【寻找发光的石头】\x07\x00完成！\x02",
    )
    ...
    AnonymousTalk(    #84
        "\x07\x00交出了\x07\x02齿轮\x07\x00。\x02",
    )
