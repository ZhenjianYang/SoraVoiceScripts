...
def main():
    ...
    AnonymousTalk(    #4
        "\x07\x05众人向管家说明了深处的门被锁上了的事情。\x02",
    )
    ...
    AnonymousTalk(    #72
        "\x07\x00得到了\x07\x02备用钥匙\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #120
        "\x07\x05科洛蒂娅公主取出了一幅古老的地图。\x07\x00\x02",
    )
