...
def main():
    ...
    ChrTalk(    #190 op#A op#5
        0x10,
        "#422F#13A#2P什…………\x05\x02",
    )


    ChrTalk(    #191 op#A op#5
        0x11,
