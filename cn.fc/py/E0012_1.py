...
def main():
    ...
    AnonymousTalk(    #3
        "\x07\x00交出了\x07\x02给菲的情书\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #9
        "\x07\x00交出了\x07\x02工作手套\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #21
        "\x07\x00交出了\x07\x02果馅饼\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #33
        "\x07\x00交出了\x07\x02绒毛编织帽\x07\x00。\x02",
    )
