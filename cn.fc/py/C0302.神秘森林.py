...
def main():
    ...
    AnonymousTalk(    #39
        "\x07\x00取回了\x07\x02七耀石的结晶\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #73
        "\x07\x00得到了\x07\x02熊刺草\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #74
        (
            "\x07\x02熊刺草\x07\x00发现了，\x01",
            "\x07\x00不过现有的数量太多，不能再拿更多了。\x02",
        )
    )
    ...
    AnonymousTalk(    #75
        "\x07\x00得到了\x07\x02兽皮制服\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #76
        (
            "宝箱里装有\x07\x02兽皮制服\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02兽皮制服\x07\x00不能再拿更多了。\x02",
        )
    )
