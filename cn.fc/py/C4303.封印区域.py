...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #89 op#A op#5
        "\x07\x02#15A门电路固定……\x05\x02",
    )

    Sleep(2000)

    AnonymousTalk(    #90 op#A op#5
        "\x07\x02#15A导力供给恢复……\x05\x02",
    )

    Sleep(2700)

    AnonymousTalk(    #91 op#A op#5
        "\x07\x02#15A再启动完成……\x05\x02",
    )

    Sleep(2500)

    AnonymousTalk(    #92 op#A op#5
        "\x07\x02#15AMODE：搜索入侵敌人……\x05\x02",
    )
    ...
    AnonymousTalk(    #95 op#A op#5
        "\x07\x02#10A『环之守护者』幻想乐曲…\x05\x02",
    )
    ...
    AnonymousTalk(    #96 op#A op#5
        "\x07\x02#20A搜索入侵敌人，行动再次开始……\x05\x02",
    )
