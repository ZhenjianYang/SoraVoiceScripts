...
def main():
    ...
    AnonymousTalk(    #7
        (
            "\x07\x05※根据接触方式不同，战斗开始时的状况也会不同。\x01",
            "  接触魔兽背后有利战斗，\x01",
            "  被魔兽从背后接触则不利战斗。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #11
        (
            "\x07\x05※结晶回路的安装在[Orbment]界面进行。\x01",
            "  要开启[Orbment]界面\x01",
    ...
    AnonymousTalk(    #15
        (
            "\x07\x05※在普通攻击很难对敌人起效的情况下，魔法就很有效。\x01",
            "魔法还可以远距离攻击，\x01",
    ...
    AnonymousTalk(    #23
        (
            "\x07\x05※Ｓ爆发技即无视ＡＴ（行动顺序）而直接发动Ｓ战技。\x01",
            "  作为Ｓ爆发技发动的Ｓ战技，\x01",
    ...
    AnonymousTalk(    #27
        (
            "\x07\x05※这些ＡＴ奖励对敌我双方都发挥同样的效果。\x01",
            "  熟练错开行动顺序的话，\x01",
    ...
    AnonymousTalk(    #28
        "\x07\x00得到了２个\x07\x02小箱子\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #39
        "\x07\x00得到了\x07\x02结晶回路的碎片\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #54
        "\x07\x00得到了\x07\x02复苏药\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #55
        (
            "宝箱里装有\x07\x02复苏药\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02复苏药\x07\x00不能再拿更多了。\x02",
        )
    )
