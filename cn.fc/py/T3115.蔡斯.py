...
def main():
    ...
    AnonymousTalk(    #375
        "\x07\x05艾丝蒂尔把寄给卡西乌斯的包裹里的便条交给工房长。\x02",
    )
    ...
    AnonymousTalk(    #471
        "\x07\x00使用了\x07\x02里面房间的钥匙\x07\x00。\x02",
    )
