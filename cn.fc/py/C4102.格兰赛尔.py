...
def main():
    ...
    AnonymousTalk(    #5
        "\x07\x00得到了\x07\x02防御３\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "宝箱里装有\x07\x02防御３\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02防御３\x07\x00不能再拿更多了。\x02",
        )
    )
    ...
    AnonymousTalk(    #9
        "\x07\x00得到了\x07\x02魔防３\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #10
        (
            "宝箱里装有\x07\x02魔防３\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02魔防３\x07\x00不能再拿更多了。\x02",
        )
    )
