...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00得到了\x07\x02水纹剑\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "宝箱里装有\x07\x02水纹剑\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02水纹剑\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #9
        "\x07\x00得到了\x07\x02战斗服\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #10
        (
            "宝箱里装有\x07\x02战斗服\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02战斗服\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #13
        "\x07\x00得到了\x07\x02军用靴\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #14
        (
            "宝箱里装有\x07\x02军用靴\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02军用靴\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #16
        "\x07\x00得到了\x07\x02ＥＰ填充剂\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #17
        (
            "宝箱里装有\x07\x02ＥＰ填充剂\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02ＥＰ填充剂\x07\x00不能再拿更多了。\x02",
        )
    )
