...
def main():
    ...
    AnonymousTalk(    #11
        "\x07\x00得到了\x07\x02宝石戒指\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #12
        (
            "宝箱里装有\x07\x02宝石戒指\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02宝石戒指\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #14
        "\x07\x00得到了\x07\x02毒蝎鞭\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #15
        (
            "宝箱里装有\x07\x02毒蝎鞭\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02毒蝎鞭\x07\x00不能再拿更多了。\x02",
        )
    )
