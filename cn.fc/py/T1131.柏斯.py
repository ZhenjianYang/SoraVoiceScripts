...
def main():
    ...
    AnonymousTalk(    #0
        "\x06\x07\x00尝了尝\x07\x02仰天奶酪肉汁烩饭\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #1
        "\x06\x07\x00学会了\x07\x02仰天奶酪肉汁烩饭\x07\x00的做法。\x02",
    )
    ...
    AnonymousTalk(    #564
        "\x07\x00得到了\x07\x02梅贝尔市长的信\x07\x00。\x02",
    )
