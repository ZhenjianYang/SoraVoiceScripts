...
def main():
    ...
    AnonymousTalk(    #22
        "\x07\x00得到了\x07\x02黑色手镯\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #23
        (
            "宝箱里装有\x07\x02黑色手镯\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02黑色手镯\x07\x00不能再拿更多了。\x02",
        )
    )
