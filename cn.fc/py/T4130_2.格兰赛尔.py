...
def main():
    ...
    AnonymousTalk(    #324
        "\x06\x07\x00尝了尝\x07\x02巨匠咖喱饭\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #325
        "\x06\x07\x00学会了\x07\x02巨匠咖喱饭\x07\x00的做法。\x02",
    )
    ...
    AnonymousTalk(    #343
        "\x07\x00得到了\x07\x02太极棍\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #345
        "\x07\x00得到了\x07\x02黑千鸟·白千鸟\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #466
        "\x06\x07\x00尝了尝\x07\x02劲霸浓鱼汤\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #467
        "\x06\x07\x00学会了\x07\x02劲霸浓鱼汤\x07\x00的做法。\x02",
    )
