...
def main():
    ...
    AnonymousTalk(    #378
        "\x07\x00得到了\x07\x02卢安经济史·中\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #438
        (
            "\x07\x024 Error(s)...  0 Warning(s)...\x01",
            "导力相性占卜机...强制中止\x02",
        )
    )
