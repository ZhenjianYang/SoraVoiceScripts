...
def main():
    ...
    AnonymousTalk(    #51
        "\x07\x00把\x07\x02市长的介绍信\x07\x00交给了加通矿长。\x02",
    )
    ...
    AnonymousTalk(    #58
        "\x07\x05矿长从怀中取出大颗的结晶。\x07\x05\x02",
    )
    ...
    AnonymousTalk(    #66
        "\x07\x00得到了\x07\x02七耀石的结晶\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #71
        "\x07\x05艾丝蒂尔把结晶收在怀里。\x07\x05\x02",
    )
    ...
    AnonymousTalk(    #105
        "\x07\x00得到了２个\x07\x02回复药\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #128
        "\x07\x00借来了\x07\x02导力梯的钥匙\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #206
        "\x07\x05使用了\x07\x05导力梯的钥匙\x07\x05。\x02",
    )
