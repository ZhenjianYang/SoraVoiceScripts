...
def main():
    ...
    AnonymousTalk(    #232
        "\x07\x00得到了\x07\x02地下水路的钥匙Ｂ\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #243
        "\x07\x05艾丝蒂尔他们说明了关于空贼和特务兵小组的事情。\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #464
        "\x07\x00交出了所有的\x07\x02正游击士资格的推荐信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #474
        "\x07\x00得到了\x07\x02正游击士的徽章\x07\x00。\x02",
    )
