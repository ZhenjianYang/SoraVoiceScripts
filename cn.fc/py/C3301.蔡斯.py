...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #4
        "\x07\x00得到了\x07\x02ＥＰ３\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "宝箱里装有\x07\x02ＥＰ３\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02ＥＰ３\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #8
        "\x07\x00得到了\x07\x02Ｇ－冲击炮\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #9
        (
            "宝箱里装有\x07\x02Ｇ－冲击炮\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02Ｇ－冲击炮\x07\x00不能再拿更多了。\x02",
        )
    )
