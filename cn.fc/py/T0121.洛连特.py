...
def main():
    ...
    AnonymousTalk(    #82
        "\x07\x00得到了\x07\x02游击士协会的介绍信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #132
        "\x07\x00得到了\x07\x02游击士手册\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #275
        "\x07\x00购入\x07\x02利贝尔通讯 第１号\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #368
        (
            "\x07\x05※站在柜台附近时会出现『TALK』的标记，\x01",
            "　用右键点击会出现选择菜单。\x01",
    ...
    AnonymousTalk(    #370
        (
            "\x07\x05※手册在Camp内［Item］栏的［书籍］中。\x01",
    ...
    AnonymousTalk(    #407
        "\x07\x00得到了\x07\x02正游击士资格的推荐信\x07\x00。\x02",
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #468
        "\x06\x07\x00#020F想知道关于哪方面的内容？\x02",
    )
    ...
    AnonymousTalk(    #508
        "\x07\x00得到了\x07\x02准游击士的徽章\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #541
        "\x07\x00得到了\x07\x02致卡西乌斯的信\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #548
        "\x07\x00得到了\x07\x02料理手册\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #552
        "\x07\x00得到了\x07\x02枫糖曲奇\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #554
        "\x06\x07\x00尝了尝\x07\x02枫糖曲奇\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #555
        "\x06\x07\x00学会了\x07\x02枫糖曲奇\x07\x00的做法。\x02",
    )
    ...
    ChrTalk(    #556
        ...
        (
            ...
            "\x07\x04尝过料理并且记住它的做法\x07\x00是基本的要领。\x01",
            "没见过的料理更要去尝尝看，\x01",
            "反正看到什么吃什么就是了。\x02",
        )
    )
