...
def main():
    ...
    AnonymousTalk(    #198
        "\x07\x00得到了\x07\x02晚宴请帖\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #199
        "\x07\x00得到奖金\x07\x04１０００００\x07\x00米拉。\x02",
    )
