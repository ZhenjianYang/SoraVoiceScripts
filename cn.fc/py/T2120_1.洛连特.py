...
def main():
    ...
    AnonymousTalk(    #14
        "\x07\x00得到了\x07\x02维修工具箱\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #68
        "\x07\x00归还了\x07\x02维修工具箱\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #72
        "\x07\x00交出了\x07\x02试·零式导力枪\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #82
        "\x07\x00得到了\x07\x02攻击２\x07\x00的结晶回路。\x02",
    )
