...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05成功消灭了地下水路·西部区域中被通缉的魔兽！\x02",
    )
    ...
    AnonymousTalk(    #4
        "\x07\x05成功消灭了地下水路·东部区域中被通缉的魔兽！\x02",
    )
    ...
    AnonymousTalk(    #6
        "\x07\x00得到了\x07\x02反射大衣\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #7
        (
            "宝箱里装有\x07\x02反射大衣\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02反射大衣\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #10
        "\x07\x00得到了\x07\x02拳斗士手套\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #11
        (
            "宝箱里装有\x07\x02拳斗士手套\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02拳斗士手套\x07\x00不能再拿更多了。\x02",
        )
    )
