...
def main():
    ...
    AnonymousTalk(    #17
        "\x07\x00得到了\x07\x02红耀石　第６卷\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #72
        "\x06\x07\x00尝了尝\x07\x02学院午餐\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #73
        "\x06\x07\x00学会了\x07\x02学院午餐\x07\x00的做法。\x02",
    )
    ...
    AnonymousTalk(    #79
        "\x07\x00得到了\x07\x02沙拉三明治\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #154
        "\x07\x00得到了\x07\x02卢安经济史·上\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #155
        "\x07\x00归还了\x07\x02卢安经济史·上\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #156
        "\x07\x00归还了\x07\x02卢安经济史·中\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #157
        "\x07\x00归还了\x07\x02卢安经济史·下\x07\x00。\x02",
    )
