...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00得到了\x07\x02回复药\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "宝箱里装有\x07\x02回复药\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02回复药\x07\x00不能再拿更多了。\x02",
        )
    )
    ...
    AnonymousTalk(    #4
        "\x07\x00得到了\x07\x02魔兽肉排\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "宝箱里装有\x07\x02魔兽肉排\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02魔兽肉排\x07\x00不能再拿更多了。\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x00得到了\x07\x02死之刃２\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #8
        (
            "宝箱里装有\x07\x02死之刃２\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02死之刃２\x07\x00不能再拿更多了。\x02",
        )
    )
