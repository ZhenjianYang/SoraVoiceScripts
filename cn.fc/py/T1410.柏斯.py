...
def main():
    ...
    AnonymousTalk(    #64
        "\x07\x00得到了\x07\x02红耀石　第３卷\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #236
        "\x07\x00交出了\x07\x02黑色笔记本\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #265
        "\x07\x00交出了\x07\x02梅贝尔市长的信\x07\x00。\x02",
    )
