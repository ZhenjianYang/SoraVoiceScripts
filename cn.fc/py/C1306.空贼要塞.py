...
def main():
    ...
    AnonymousTalk(    #29
        "\x07\x00得到了\x07\x02黑色笔记本\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #34
        "\x07\x00得到了\x07\x02狩猎枪\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #35
        (
            "宝箱里装有\x07\x02狩猎枪\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02狩猎枪\x07\x00不能再拿更多了。\x02",
        )
    )
...
#STEAM_ONLY_END
    ...
    AnonymousTalk(    #37
        "\x07\x00得到了\x07\x02斯托雷加Ｒ\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #38
        (
            "宝箱里装有\x07\x02斯托雷加Ｒ\x07\x00。\x01",
            "不过现有的数量太多，\x07\x02斯托雷加Ｒ\x07\x00不能再拿更多了。\x02",
        )
    )
