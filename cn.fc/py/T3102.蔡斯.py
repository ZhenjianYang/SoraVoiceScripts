...
def main():
    ...
    AnonymousTalk(    #69
        "\x07\x00把两张\x07\x02船票\x07\x00还了回去。\x02",
    )
    ...
    AnonymousTalk(    #86
        "\x07\x00得到两张\x07\x02船票\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #206
        "\x07\x00得到了\x07\x02内燃引擎设备\x07\x00。\x02",
    )
