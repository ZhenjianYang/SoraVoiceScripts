...
def main():
    ...
    def Function_4_8B7(): pass

    label("Function_4_8B7")
    ...
    QueueWorkItem(0x18, 0, lambda_9F9)

    def lambda_A11():
        OP_67(0, 3930, -10000, 7000)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_A11)

    def lambda_A29():
        OP_6B(2470, 7000)
        ExitThread()

    QueueWorkItem(0x18, 2, lambda_A29)

    def lambda_A39():
        OP_6E(333, 7000)
        ExitThread()

    QueueWorkItem(0x18, 3, lambda_A39)
    FadeToBright(2000, 0)
    OP_0D()
    ...
    ChrTalk(    #31
        ...
        (
            ...
            "#1113F当然，\x01",
            "您身为『泰斗流』的奥义传人\x01",
            "所拥有的实力也是理由之一……\x02\x03",

            "#1110F不过比这更重要的，\x01",
            "是您作为协会接待所展现出来的\x01",
            "卓越的情报处理与分析能力。\x02\x03",
    ...
    QueueWorkItem(0x18, 0, lambda_178C)
    OP_22(0x8F, 0x0, 0x64)
    SetChrChipByIndex(0x14, 4)
    SetChrSubChip(0x14, 0)
    SetChrPos(0x14, 12150, 0, 8230, 0)
    ...
    QueueWorkItem(0x18, 0, lambda_1854)
    ...
    QueueWorkItem(0x18, 0, lambda_1977)
    OP_43(0x14, 0x1, 0x0, 0x4)
    Sleep(1000)
    FadeToDark(2000, 0, -1)
    OP_0D()
