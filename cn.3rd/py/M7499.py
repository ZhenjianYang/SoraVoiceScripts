...
def main():
    ...
    QueueWorkItem(0x12, 0, lambda_8F9)

    def lambda_911():
        OP_67(0, 0, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_911)

    def lambda_929():
        OP_6B(2000, 8000)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_929)

    def lambda_939():
        OP_6E(600, 8000)
        ExitThread()

    QueueWorkItem(0x12, 3, lambda_939)
    Sleep(2000)
    ...
    def Function_3_9DF(): pass

    label("Function_3_9DF")
    ...
    def Function_4_A38(): pass

    label("Function_4_A38")
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_A6A")
    ...
    def Function_6_A6B(): pass

    label("Function_6_A6B")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_A86")
    ...
    def Function_7_A87(): pass

    label("Function_7_A87")
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_AB4")
    ...
    def Function_9_AB5(): pass

    label("Function_9_AB5")
