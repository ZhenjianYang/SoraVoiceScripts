...
def main():
    ...
    ScpFunction(
        ...
        "Function_12_57E",         # 0C, 12
        "Function_13_600",         # 0D, 13
        "Function_14_69C",         # 0E, 14
        "Function_15_732",         # 0F, 15
        "Function_16_910",         # 10, 16
        "Function_17_995",         # 11, 17
        "Function_18_A27",         # 12, 18
        "Function_19_AB9",         # 13, 19
        "Function_20_B4F",         # 14, 20
        "Function_21_BD2",         # 15, 21
    )
    ...
    def Function_12_57E(): pass

    label("Function_12_57E")
    ...
    def Function_13_600(): pass

    label("Function_13_600")
    ...
    def Function_14_69C(): pass

    label("Function_14_69C")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x24, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_711")

    def lambda_6DB():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_6DB)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_15_732(): pass

    label("Function_15_732")
    ...
    QueueWorkItem(0x11, 0, lambda_750)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    QueueWorkItem2(0x10, 3, lambda_826)
    OP_6D(0, 0, -3000, 1500)
    ...
    QueueWorkItem(0x10, 0, lambda_89C)
    Sleep(500)
    OP_82(0x0, 0x2)
    ...
    QueueWorkItem(0x0, 0, lambda_8D7)

    def lambda_8EF():
        OP_6B(2280, 200)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_8EF)
    WaitChrThread(0x0, 0x0)
    ...
    def Function_16_910(): pass

    label("Function_16_910")
    ...
    def Function_17_995(): pass

    label("Function_17_995")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0xA, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x19, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A18")

    def lambda_9BE():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_9BE)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    def Function_18_A27(): pass

    label("Function_18_A27")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0xB, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1F, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AAA")

    def lambda_A50():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_A50)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    def Function_19_AB9(): pass

    label("Function_19_AB9")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1C, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B2E")

    def lambda_AF8():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_AF8)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_20_B4F(): pass

    label("Function_20_B4F")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0xF, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x18, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BC3")

    def lambda_B78():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_B78)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    def Function_21_BD2(): pass

    label("Function_21_BD2")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x10, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x21, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C55")

    def lambda_BFB():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_BFB)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
