...
def main():
    ...
    AnonymousTalk(    #0 op#A
        "\x07\x00#15A#4STestimony 1\x18\x02",
    )
    ...
    ChrTalk(    #1
        0x11,
        "#11PThose two certainly did come here, yes.\x02",
    )
    ...
    ChrTalk(    #2
        0x11,
        (
            "#11PI remember them sitting at the table over there\x01",
            "having a pleasant conversation with one another.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0x11,
        (
            "#11PI couldn't tell you what they were talking about,\x01",
            "I'm afraid...\x02",
        )
    )
    ...
    ChrTalk(    #4
        0x11,
        (
            "#11PBut I do remember seeing Lila smiling while talking,\x01",
            "which you don't see every day with her. That struck\x01",
            "me.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x15,
        (
            "#819F#6PR-Really, now...?\x02\x03",

            "#816FDo you remember anything about the man,\x01",
            "by the way?\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x11,
        (
            "#11PNot in much detail... Just that he was a well-\x01",
            "groomed, seemingly pleasant young man.\x02",
        )
    )
    ...
    ChrTalk(    #7
        0x11,
        "#11PThat's about all I can say, I'm afraid.\x02",
    )
    ...
    ChrTalk(    #9
        0x11,
        "#11PCan I ask why you want to know all of this?\x02",
    )
    ...
    ChrTalk(    #11
        0x11,
        (
            "#11PWait, it's okay. You don't need to answer.\x01",
            "They're in love, aren't they?\x02",
        )
    )
    ...
    ChrTalk(    #13
        0x11,
        (
            "#11PShe did very much look like a girl in love\x01",
            "when she was talking to him, you know.\x02",
        )
    )
    ...
    ChrTalk(    #14
        0x11,
        (
            "#11PSo little Lila's finally ready to begin her \x01",
            "journey into adulthood, is she? Awww...\x01",
            "How sweet!\x02",
        )
    )
    ...
    ChrTalk(    #15
        0x15,
        (
            "#1316F#6PW-We don't know for sure yet...\x02\x03",

            "#1314FSo please, please keep this to yourself, okay?\x01",
            "Don't go telling any of the other customers and\x01",
            "starting any rumors.\x02",
        )
    )
    ...
    ChrTalk(    #16
        0x11,
        "#11PHeehee. Not to worry! The secret's safe with me! ☆\x02",
    )
