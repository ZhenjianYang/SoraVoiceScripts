...
def main():
    ...
    ScpFunction(
        ...
        "Function_12_780",         # 0C, 12
        "Function_13_835",         # 0D, 13
        "Function_14_8E9",         # 0E, 14
        "Function_15_983",         # 0F, 15
        "Function_16_A19",         # 10, 16
        "Function_17_A91",         # 11, 17
        "Function_18_C90",         # 12, 18
        "Function_19_D1B",         # 13, 19
        "Function_20_DB7",         # 14, 20
        "Function_21_E7A",         # 15, 21
        "Function_22_F0F",         # 16, 22
        "Function_23_FA8",         # 17, 23
        "Function_24_1046",        # 18, 24
        "Function_25_10DD",        # 19, 25
        "Function_26_117B",        # 1A, 26
        "Function_27_1375",        # 1B, 27
        "Function_28_1435",        # 1C, 28
        "Function_29_151F",        # 1D, 29
        "Function_30_15B6",        # 1E, 30
        "Function_31_17A2",        # 1F, 31
        "Function_32_1825",        # 20, 32
        "Function_33_18B9",        # 21, 33
        "Function_34_1AB3",        # 22, 34
        "Function_35_1B36",        # 23, 35
        "Function_36_1BCA",        # 24, 36
        "Function_37_1DC4",        # 25, 37
        "Function_38_1E47",        # 26, 38
        "Function_39_1EDB",        # 27, 39
        "Function_40_20D5",        # 28, 40
        "Function_41_2158",        # 29, 41
        "Function_42_21EC",        # 2A, 42
        "Function_43_23DD",        # 2B, 43
        "Function_44_246E",        # 2C, 44
    )
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05\x18#2S#40WI shall grant to you a memory fragment\x01",
            "and my blessing...\x02",
        )
    )
    ...
    def Function_12_780(): pass

    label("Function_12_780")
    ...
    def Function_13_835(): pass

    label("Function_13_835")
    ...
    def Function_14_8E9(): pass

    label("Function_14_8E9")
    ...
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xD, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_95D")

    def lambda_91B():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_91B)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_15_983(): pass

    label("Function_15_983")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x9, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9F8")

    def lambda_9C2():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_9C2)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_16_A19(): pass

    label("Function_16_A19")
    ...
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xF, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A7D")

    def lambda_A47():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_A47)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_17_A91(): pass

    label("Function_17_A91")
    ...
    QueueWorkItem(0x11, 0, lambda_AAF)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    QueueWorkItem2(0x10, 3, lambda_B90)

    def lambda_BA3():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_BA3)

    def lambda_BBB():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_BBB)

    def lambda_BD3():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_BD3)

    def lambda_BE3():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_BE3)
    WaitChrThread(0x11, 0x0)
    ...
    QueueWorkItem(0x10, 0, lambda_C4A)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    ...
    def Function_18_C90(): pass

    label("Function_18_C90")
    ...
    def Function_19_D1B(): pass

    label("Function_19_D1B")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x4, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x10, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D9E")

    def lambda_D44():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_D44)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    def Function_20_DB7(): pass

    label("Function_20_DB7")
    ...
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x7, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E2B")

    def lambda_DE9():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_DE9)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_21_E7A(): pass

    label("Function_21_E7A")
    ...
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x8, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EEE")

    def lambda_EAC():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_EAC)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_22_F0F(): pass

    label("Function_22_F0F")
    ...
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x11, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F83")

    def lambda_F41():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_F41)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_23_FA8(): pass

    label("Function_23_FA8")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xA, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_101D")

    def lambda_FE7():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_FE7)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    def Function_24_1046(): pass

    label("Function_24_1046")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x13, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xB, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_10C9")

    def lambda_106F():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_106F)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_24_1046 end

    def Function_25_10DD(): pass

    label("Function_25_10DD")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xE, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1152")

    def lambda_111C():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_111C)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    # Function_25_10DD end

    def Function_26_117B(): pass

    label("Function_26_117B")
    ...
    QueueWorkItem(0x11, 0, lambda_1199)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    QueueWorkItem2(0x10, 3, lambda_127A)

    def lambda_128D():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_128D)

    def lambda_12A5():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_12A5)

    def lambda_12BD():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_12BD)

    def lambda_12CD():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_12CD)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    ...
    QueueWorkItem(0x10, 0, lambda_1334)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_26_117B end

    def Function_27_1375(): pass

    label("Function_27_1375")
    ...
    # Function_27_1375 end

    def Function_28_1435(): pass

    label("Function_28_1435")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0xD, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xC, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_14B8")

    def lambda_145E():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_145E)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_28_1435 end

    def Function_29_151F(): pass

    label("Function_29_151F")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x1D, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x12, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_15A2")

    def lambda_1548():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_1548)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_29_151F end

    def Function_30_15B6(): pass

    label("Function_30_15B6")
    ...
    QueueWorkItem(0x11, 0, lambda_15EA)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    ...
    QueueWorkItem2(0x10, 3, lambda_16A7)

    def lambda_16BA():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_16BA)

    def lambda_16D2():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_16D2)

    def lambda_16EA():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_16EA)

    def lambda_16FA():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_16FA)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    PlayEffect(0x1, 0x1, 0xFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0xFF, 0, 0, 0, 0)
    OP_22(0x99, 0x0, 0x64)
    ...
    QueueWorkItem(0x10, 0, lambda_1761)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_30_15B6 end

    def Function_31_17A2(): pass

    label("Function_31_17A2")
    ...
    # Function_31_17A2 end

    def Function_32_1825(): pass

    label("Function_32_1825")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x1E, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x13, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_18A8")

    def lambda_184E():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_184E)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_32_1825 end

    def Function_33_18B9(): pass

    label("Function_33_18B9")
    ...
    QueueWorkItem(0x11, 0, lambda_18D7)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    QueueWorkItem2(0x10, 3, lambda_19B8)

    def lambda_19CB():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_19CB)

    def lambda_19E3():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_19E3)

    def lambda_19FB():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_19FB)

    def lambda_1A0B():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_1A0B)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    PlayEffect(0x1, 0x1, 0xFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0xFF, 0, 0, 0, 0)
    OP_22(0x99, 0x0, 0x64)
    ...
    QueueWorkItem(0x10, 0, lambda_1A72)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_33_18B9 end

    def Function_34_1AB3(): pass

    label("Function_34_1AB3")
    ...
    # Function_34_1AB3 end

    def Function_35_1B36(): pass

    label("Function_35_1B36")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x1F, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x14, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1BB9")

    def lambda_1B5F():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_1B5F)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_35_1B36 end

    def Function_36_1BCA(): pass

    label("Function_36_1BCA")
    ...
    QueueWorkItem(0x11, 0, lambda_1BE8)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    QueueWorkItem2(0x10, 3, lambda_1CC9)

    def lambda_1CDC():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_1CDC)

    def lambda_1CF4():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1CF4)

    def lambda_1D0C():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_1D0C)

    def lambda_1D1C():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_1D1C)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    PlayEffect(0x1, 0x1, 0xFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0xFF, 0, 0, 0, 0)
    OP_22(0x99, 0x0, 0x64)
    ...
    QueueWorkItem(0x10, 0, lambda_1D83)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_36_1BCA end

    def Function_37_1DC4(): pass

    label("Function_37_1DC4")
    ...
    # Function_37_1DC4 end

    def Function_38_1E47(): pass

    label("Function_38_1E47")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x20, 0, 0x0)
    Call(0, 7)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x15, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1ECA")

    def lambda_1E70():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_1E70)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_38_1E47 end

    def Function_39_1EDB(): pass

    label("Function_39_1EDB")
    ...
    QueueWorkItem(0x11, 0, lambda_1EF9)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    QueueWorkItem2(0x10, 3, lambda_1FDA)

    def lambda_1FED():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_1FED)

    def lambda_2005():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2005)
    ...
    QueueWorkItem(0x11, 3, lambda_202D)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    PlayEffect(0x1, 0x1, 0xFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0xFF, 0, 0, 0, 0)
    OP_22(0x99, 0x0, 0x64)
    ...
    QueueWorkItem(0x10, 0, lambda_2094)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_39_1EDB end

    def Function_40_20D5(): pass

    label("Function_40_20D5")
    ...
    # Function_40_20D5 end

    def Function_41_2158(): pass

    label("Function_41_2158")

    EventBegin(0x0)
    FadeToDark(0, 0, -1)
    OP_E3(0x0, 0x21, 0, 0x0)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x16, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_21DB")
    Call(0, 7)
    ...
    QueueWorkItem(0x11, 0, lambda_2181)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x0, 0x0, 0x0, 0x2)
    ...
    # Function_41_2158 end

    def Function_42_21EC(): pass

    label("Function_42_21EC")
    ...
    QueueWorkItem(0x11, 0, lambda_2225)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x110, 0x0, 0x0, 0x3)
    ...
    QueueWorkItem2(0x10, 3, lambda_22E2)

    def lambda_22F5():
        OP_6D(1120, 110, -2080, 1500)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_22F5)

    def lambda_230D():
        OP_67(0, 4750, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_230D)

    def lambda_2325():
        OP_6B(2350, 1500)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_2325)

    def lambda_2335():
        OP_6E(406, 1500)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_2335)
    WaitChrThread(0x11, 0x0)
    LoadEffect(0x1, "map\\mp250_01.eff")
    PlayEffect(0x1, 0x1, 0xFF, 0, 0, 0, 0, 0, 0, 1000, 1000, 1000, 0xFF, 0, 0, 0, 0)
    OP_22(0x99, 0x0, 0x64)
    ...
    QueueWorkItem(0x10, 0, lambda_239C)
    Sleep(500)
    OP_82(0x0, 0x2)
    OP_82(0x1, 0x2)
    WaitChrThread(0x10, 0x0)
    ...
    # Function_42_21EC end

    def Function_43_23DD(): pass

    label("Function_43_23DD")
    ...
    # Function_43_23DD end

    def Function_44_246E(): pass

    label("Function_44_246E")
    ...
    Call(0, 7)
    SetChrPos(0x110, 0, 0, -16000, 0)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x17, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_24E3")

    def lambda_24AD():
        OP_6B(3100, 4000)
        ExitThread()

    QueueWorkItem(0x11, 0, lambda_24AD)
    FadeToBright(2000, 0)
    OP_0D()
    Sleep(1000)
    OP_43(0x110, 0x0, 0x0, 0x3)
