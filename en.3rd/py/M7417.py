...
def main():
    ...
    AnonymousTalk(    #0
        "\x07\x05No time like the present, right? Go get 'em!\x02",
    )
    ...
    def Function_3_337(): pass

    label("Function_3_337")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x595, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_410")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x201, 1)"), scpexpr(EXPR_END)), "loc_3A5")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #3
        "\x07\x05Until next time, see ya.\x07\x00\x02",
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x595, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_533")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x179, 1)"), scpexpr(EXPR_END)), "loc_4C8")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #4
        "\x07\x05Found \x1F\x79\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x05Found \x1F\x79\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\x79\x01\x07\x05.\x02",
        )
    )
