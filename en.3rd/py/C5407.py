...
def main():
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05Access to the sanctuary and engine room is\x01",
            "currently limited.\x02",
        )
    )
    ...
    AnonymousTalk(    #1
        "\x07\x05Please confirm your identity.\x02",
    )
    ...
    ChrTalk(    #2
        0x124,
        (
            "#120F#6PEnforcer No. II, Leonardt the Bladelord.\x02\x03",

            "I'm on my way to the sanctuary.\x02",
        )
    )
    ...
    QueueWorkItem(0xFE, 2, lambda_255)
    ...
    def Function_4_28A(): pass

    label("Function_4_28A")
