...
def main():
    ...
    ScpFunction(
        ...
        "Function_15_BFD",         # 0F, 15
        "Function_16_DDA",         # 10, 16
        "Function_17_E93",         # 11, 17
    )
    ...
    def Function_15_BFD(): pass

    label("Function_15_BFD")
    ...
    OP_6E(262, 0)
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x8, 0x0, 0x2)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_CD3")
    OP_28(0x8, 0x4, 0x2)
    OP_82(0x82, 0x2)
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05#40WBring to me the playful minstrel and\x01",
            "his closest ally against the beast they\x01",
            "seek to overcome.\x01",
            "#500W \x01",
    ...
    OP_C4(0x1, 0x800)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x3)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_EXEC_OP, "OP_42(0xC)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_DCE")
    Call(0, 14)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DCB")
    Call(0, 16)
    ...
    def Function_16_DDA(): pass

    label("Function_16_DDA")
    ...
    QueueWorkItem(0x0, 2, lambda_E43)
    ...
    def Function_17_E93(): pass

    label("Function_17_E93")
