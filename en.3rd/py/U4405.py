...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4F7, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1CE")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x14C, 1)"), scpexpr(EXPR_END)), "loc_163")
    ...
    AnonymousTalk(    #2
        "\x07\x05Ries-king your life only to run all the way back to an empty chest?\x07\x00\x02",
    )

    CloseMessageWindow()
    OP_56(0x0)
    FadeToBright(300, 0)
    OP_F7(0x19, 0x140, 0x0)
