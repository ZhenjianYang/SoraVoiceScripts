...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x530, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_5F8")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1C, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x150, 1)"), scpexpr(EXPR_END)), "loc_58D")
    ...
    AnonymousTalk(    #0
        "\x07\x05Found \x1F\x50\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05Found \x1F\x50\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\x50\x01\x07\x05.\x02",
        )
    )
    ...
    AnonymousTalk(    #2
        "\x07\x05This... This is not what it looks like!\x07\x00\x02",
    )
    ...
    OP_70(0x1A, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FB, 1)"), scpexpr(EXPR_END)), "loc_6BF")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #5
        (
            "\x07\x05Your luscious locks of hair are NOTHING compared to my lovely locks of\x01",
            "steel!\x07\x00\x02",
        )
    )
    ...
    def Function_4_7A9(): pass

    label("Function_4_7A9")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x53A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_882")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1B, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x17A, 1)"), scpexpr(EXPR_END)), "loc_817")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #6
        "\x07\x05Found \x1F\x7A\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #7
        (
            "\x07\x05Found \x1F\x7A\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\x7A\x01\x07\x05.\x02",
        )
    )
    ...
    AnonymousTalk(    #8
        "\x07\x05I'm gonna have to start charging at this rate.\x07\x00\x02",
    )
    ...
    def Function_5_8E2(): pass

    label("Function_5_8E2")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x52A, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A0B")
    EventBegin(0x0)
    OP_6F(0x2A, 0)
    OP_70(0x2A, 0xF0)
    OP_22(0x64, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x52A, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AC8")
    TalkBegin(0xFF)
    FadeToDark(300, 0, 100)

    AnonymousTalk(    #10
        "\x07\x05The door can't be opened, as no orbal energy is flowing to it.\x02",
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x52A, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B8E")
    EventBegin(0x0)
    OP_6F(0x2B, 0)
    OP_70(0x2B, 0xF0)
    OP_22(0x64, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x52A, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C4B")
    TalkBegin(0xFF)
    FadeToDark(300, 0, 100)
