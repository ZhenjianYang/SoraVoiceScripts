...
def main():
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05High five!\x01",
            "Down low! ...Oh, no! I don't have hands!\x02",
        )
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x592, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_48B")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FD, 1)"), scpexpr(EXPR_END)), "loc_420")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #3
        "\x07\x05This wasn't easy, but you persevered. \x07\x00\x02",
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x592, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_5BC")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x205, 1)"), scpexpr(EXPR_END)), "loc_551")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #6
        "\x07\x05My heart is full to bursting with so many wonderful thoughts right now.\x07\x00\x02",
    )
