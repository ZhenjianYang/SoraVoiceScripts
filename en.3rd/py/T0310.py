...
def main():
    ...
    ChrTalk(    #0
        0x10,
        "#1675F#11P...Thank you for everything.\x02",
    )
    ...
    QueueWorkItem(0x10, 1, lambda_3E7)
    WaitChrThread(0x10, 0x1)
    ...
    QueueWorkItem(0x10, 1, lambda_407)
    WaitChrThread(0x10, 0x1)
    ...
    QueueWorkItem(0x10, 1, lambda_427)
    WaitChrThread(0x10, 0x1)
    FadeToDark(2000, 0, -1)
    OP_22(0x6, 0x0, 0x64)
    Sleep(300)
    ...
    QueueWorkItem(0x10, 1, lambda_45B)

    def lambda_476():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0x0, 0x3E8)
        ExitThread()

    QueueWorkItem(0x10, 2, lambda_476)
    WaitChrThread(0x10, 0x1)
    OP_22(0x7, 0x0, 0x64)
    OP_0D()
    OP_A2(0x2506)
