...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4F4, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_251")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x16, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x167, 1)"), scpexpr(EXPR_END)), "loc_1E6")
    ...
    AnonymousTalk(    #0
        "\x07\x05Found \x1F\x67\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05Found \x1F\x67\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\x67\x01\x07\x05.\x02",
        )
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x05[14/36] Before it fell into such a state, its owner was known far and wide\x01",
            "even before the Orbal Revolution. He was a carpenter of unparalleled skill,\x01",
            "and he was frequently commissioned to bring life to all manner of things.\x07\x00\x02",
        )
    )
