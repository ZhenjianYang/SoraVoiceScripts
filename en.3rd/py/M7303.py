...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x58C, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_33E")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1C8, 1)"), scpexpr(EXPR_END)), "loc_2D3")
    ...
    AnonymousTalk(    #0
        "\x07\x05Found \x1F\xC8\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05Found \x1F\xC8\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\xC8\x01\x07\x05.\x02",
        )
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x58C, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_45C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1C9, 1)"), scpexpr(EXPR_END)), "loc_3F1")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #3
        "\x07\x05Found \x1F\xC9\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #4
        (
            "\x07\x05Found \x1F\xC9\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\xC9\x01\x07\x05.\x02",
        )
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x58D, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_57A")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x180, 1)"), scpexpr(EXPR_END)), "loc_50F")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #6
        "\x07\x05Found \x1F\x80\x01\x07\x05.\x02",
    )
    ...
    AnonymousTalk(    #7
        (
            "\x07\x05Found \x1F\x80\x01\x07\x05 in chest.\x01",
            "\x07\x05Inventory full so gave up \x1F\x80\x01\x07\x05.\x02",
        )
    )
