...
def main():
    ...
    def Function_3_176(): pass

    label("Function_3_176")
    ...
    OP_6E(280, 0)
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x4, 0x0, 0x2)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_24C")
    OP_28(0x4, 0x4, 0x2)
    OP_82(0x81, 0x2)
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05#40WBring to me the dancer with silver locks.\x01",
            "#500W \x01",
    ...
    OP_C4(0x1, 0x800)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x2)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_307")
    Call(0, 2)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_304")
    Call(0, 4)
    ...
    QueueWorkItem(0x0, 2, lambda_37C)
    ...
    def Function_5_3C9(): pass

    label("Function_5_3C9")
    ...
    def Function_6_474(): pass

    label("Function_6_474")

    TalkBegin(0xFF)
    FadeToDark(300, 0, 100)

    AnonymousTalk(    #2
        "\x07\x05Orbal communications aren't usable.\x02",
    )
