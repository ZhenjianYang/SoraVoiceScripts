...
def main():
    ...
    QueueWorkItem(0x101, 1, lambda_207)

    def lambda_21F():
        OP_6B(6500, 10000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_21F)
    Sleep(500)
    FadeToBright(2000, 0)
    Sleep(2000)
    ...
    QueueWorkItem(0x9, 1, lambda_2A8)
    Sleep(1000)
    Fade(500)
    ...
    QueueWorkItem(0xA, 1, lambda_31D)
    ...
    QueueWorkItem(0x101, 2, lambda_350)
    WaitChrThread(0x101, 0x1)
    WaitChrThread(0x101, 0x2)
    Sleep(1000)
    ...
    QueueWorkItem(0x9, 1, lambda_36F)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 1, lambda_382)
    Sleep(500)
    ...
    QueueWorkItem(0x9, 0, lambda_395)
    Sleep(400)
    ...
    QueueWorkItem(0xA, 0, lambda_3B5)
    Sleep(1000)
    Fade(500)
    ...
    QueueWorkItem(0x9, 0, lambda_44F)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 0, lambda_46F)
    ...
    QueueWorkItem(0x9, 0, lambda_494)
    ...
    QueueWorkItem(0xA, 0, lambda_4A7)
    WaitChrThread(0x101, 0x1)
    Sleep(1000)
    ...
    QueueWorkItem(0x9, 0, lambda_4E2)
    Sleep(150)
    ...
    QueueWorkItem(0xA, 0, lambda_4F5)
    Sleep(1500)
    ...
    QueueWorkItem(0x8, 2, lambda_508)

    def lambda_520():
        OP_67(0, 10550, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x8, 3, lambda_520)
    ...
    QueueWorkItem(0x9, 1, lambda_558)
    Sleep(400)
    ...
    QueueWorkItem(0xA, 1, lambda_578)
    Sleep(3200)
    FadeToDark(1000, 0, -1)
    OP_0D()
    ...
    def Function_3_5AF(): pass

    label("Function_3_5AF")
    ...
    def Function_4_62E(): pass

    label("Function_4_62E")
    ...
    def Function_5_672(): pass

    label("Function_5_672")
    ...
    QueueWorkItem(0x0, 2, lambda_6F1)
