...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x380, 1)), scpexpr(EXPR_END)), "loc_22E")
    OP_10(0x2, 0x0)
    OP_10(0x0, 0x1)
    Jump("loc_23B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x342, 3)), scpexpr(EXPR_END)), "loc_23B")
    OP_10(0x0, 0x0)
    OP_10(0x2, 0x1)
    ...
    def Function_2_23C(): pass

    label("Function_2_23C")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x360, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_314")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_2AB")
    ...
    def Function_3_353(): pass

    label("Function_3_353")
