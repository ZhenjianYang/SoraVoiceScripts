...
def main():
    ...
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x161, 1)"), scpexpr(EXPR_END)), "loc_2FF")
    ...
    AnonymousTalk(    #1
        (
            ...
            "所持物品已经满了，\x1F\x61\x01\x07\x00只能放弃了。\x02",
        )
    )
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x32C, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_47F")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x5, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x134, 1)"), scpexpr(EXPR_END)), "loc_416")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x32D, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_596")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x6, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x130, 1)"), scpexpr(EXPR_END)), "loc_52D")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #6
        "\x07\x00得到了\x1F\x30\x01\x07\x00。\x02",
    )
    ...
    AnonymousTalk(    #7
        (
            "宝箱里装有\x1F\x30\x01\x07\x00。   \x01",
            "所持物品已经满了，\x1F\x30\x01\x07\x00只能放弃了。\x02",
        )
    )
