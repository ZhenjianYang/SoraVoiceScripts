...
def main():
    ...
    QueueWorkItem(0x0, 1, lambda_177)

    def lambda_18F():
        OP_67(0, 6590, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_18F)

    def lambda_1A7():
        OP_6B(5880, 8000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_1A7)
    OP_6E(256, 7000)
    FadeToDark(1000, 0, -1)
    OP_0D()
    ...
    QueueWorkItem(0x0, 1, lambda_241)

    def lambda_259():
        OP_6B(4400, 7000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_259)
    Sleep(6000)
    FadeToDark(1000, 0, -1)
    SetMapFlags(0x2000000)
    OP_A2(0x10F1)
