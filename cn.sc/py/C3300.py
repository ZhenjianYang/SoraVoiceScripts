...
def main():
    ...
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FE, 1)"), scpexpr(EXPR_END)), "loc_281")
    ...
    def Function_3_329(): pass

    label("Function_3_329")
    ...
    QueueWorkItem(0x0, 1, lambda_355)

    def lambda_36D():
        OP_67(0, 8000, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_36D)

    def lambda_385():
        OP_6B(3200, 1500)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_385)

    def lambda_395():
        OP_6C(90000, 1500)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_395)
    Sleep(1000)
    SetChrName("")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_42B")
    EventEnd(0x1)
