...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x21E, 0)), scpexpr(EXPR_END)), "loc_223")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x21E, 1)), scpexpr(EXPR_END)), "loc_239")
    OP_A3(0x10F1)
    SetMapFlags(0x10000000)
    Event(0, 6)
    Jump("loc_258")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x345, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x345, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_255")
    Event(0, 5)
    ...
    QueueWorkItem(0x101, 1, lambda_2E7)

    def lambda_2FF():
        OP_6C(0, 8000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2FF)

    def lambda_30F():
        OP_67(0, 7350, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_30F)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 1, lambda_344)
    ...
    def Function_4_3CA(): pass

    label("Function_4_3CA")
    ...
    def Function_5_414(): pass

    label("Function_5_414")
    ...
    def Function_6_423(): pass

    label("Function_6_423")
