...
def main():
    ...
    NpcTalk(    #352 op#A op#5
        0x104,
        "金发的青年",
        "#100A#0W#035F有心追求 却消溶于空\x05\x02",
    )
    ...
    NpcTalk(    #353 op#A op#5
        0x104,
        "金发的青年",
        "#100A#0W#035F寂寞来袭 听浅风低吟……\x05\x02",
    )
    ...
    NpcTalk(    #354 op#A op#5
        0x104,
        "金发的青年",
        "#100A#0W#032F若无法传达 这份心愿\x05\x02",
    )
    ...
    NpcTalk(    #355 op#A op#5
        0x104,
        "金发的青年",
        "#100A#0W#032F至少请留下 一道浅伤……\x05\x02",
    )
