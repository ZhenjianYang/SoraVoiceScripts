...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x00Found \x07\x02Topaz Talisman\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #3
        (
            "\x07\x00Found \x07\x02Topaz Talisman\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Topaz Talisman\x07\x00.\x02",
        )
    )
