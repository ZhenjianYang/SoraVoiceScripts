...
def main():
    ...
    ChrTalk(    #0
        0x8,
        (
            "#668FWha... What's this airship?!\x02\x03",

            "Is it the Royal Army? No...\x01",
            "the coat of arms is wrong.\x02",
        )
    )
    ...
    NpcTalk(    #1
        ...
        "Woman's Voice",
        (
            "#4PIt's the Royal Guard's ship.\x01",
            "A high-speed cruiser.\x02\x03",

            "Her name is the Arseille.\x02",
        )
    )
    ...
    NpcTalk(    #2
        ...
        "Female Officer",
        (
            "#170FWell, well...looks like we got\x01",
            "here just in time.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0x8,
        (
            "#668FThat blue-and-white uniform...are\x01",
            "you Her Majesty's Royal Guard?\x02",
        )
    )
    ...
    NpcTalk(    #4
        ...
        "Female Officer",
        (
            "#176FPrecisely.\x02\x03",

            "I am the company commander,\x01",
            "Julia Schwarz.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x9,
        (
            "#172FMayor Morris Dalmore of Ruan...\x02\x03",

            "I'm placing you under arrest for\x01",
            "arson, robbery and embezzlement,\x01",
            "among other charges.\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x8,
        (
            "#668FThis is a dream...\x01",
            "It has to be...\x02\x03",

            "#664FNoooo... No no no...\x02",
        )
    )
    ...
    ChrTalk(    #8
        0x102,
        (
            "#014FJean called the Royal Army\x01",
            "for reinforcements...\x02\x03",

            "But how'd they get here so fast?\x02",
        )
    )
    ...
    ChrTalk(    #10
        0x9,
        (
            "#171FHo there, bracers!\x02\x03",

            "Your cooperation is greatly appreciated!\x01",
            "Please, let us handle this matter.\x02",
        )
    )
