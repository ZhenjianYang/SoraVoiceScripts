...
def main():
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05East: Rolent - 172 selge\x01",
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05West: Bose City - 420 selge\x01",
    ...
    AnonymousTalk(    #13
        "\x07\x00Handed over \x07\x02Gate Pass\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #19
        "\x07\x05The soldier opened the gate by remote control.\x02",
    )
    ...
    AnonymousTalk(    #70
        "\x07\x00Received \x07\x02Carnelia - Chapter 2\x07\x00.\x02",
    )
