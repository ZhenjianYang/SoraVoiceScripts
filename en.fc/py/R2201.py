...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05Alzheimer's much?\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #5
        "\x07\x05You forgot to say the magic word.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #7
        "\x07\x00Found \x07\x02Ruby Talisman\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #8
        (
            "\x07\x00Found \x07\x02Ruby Talisman\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Ruby Talisman\x07\x00.\x02",
        )
    )
