...
def main():
    ...
    ChrTalk(    #0
        0xFE,
        (
            "The Soldat Army Road has\x01",
            "been blockaded as a counter-\x01",
            "terrorist measure.\x02",
        )
    )
    ...
    ChrTalk(    #2
        0xFE,
        (
            "The central military\x01",
            "base is on high alert.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0xFE,
        (
            "Sorry, but if you're looking\x01",
            "to go exploring, you'll have\x01",
            "to come back later.\x02",
        )
    )
    ...
    AnonymousTalk(    #4
        "\x07\x05North: Fort Leiston      221 selge\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x05West:  Zeiss             116 selge\x01",
            "East:  Sanktheim Gate    105 selge\x02",
        )
    )
    ...
    AnonymousTalk(    #8
        "\x07\x05Exterminated monster on Ritter Roadway! \x02",
    )
