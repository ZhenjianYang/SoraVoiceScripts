...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05You found...a whole lotta nothing.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #9
        "\x07\x00Found \x07\x02Black Coat\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #10
        (
            "\x07\x00Found \x07\x02Black Coat\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Black Coat\x07\x00.\x02",
        )
    )
