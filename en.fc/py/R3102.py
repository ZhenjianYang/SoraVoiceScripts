...
def main():
    ...
    ChrTalk(    #0
        0xFE,
        (
            "Well, Bruno? Do you think you\x01",
            "can do anything?\x02",
        )
    )
    ...
    ChrTalk(    #1
        0xFE,
        (
            "We're going to stay out here\x01",
            "for a little longer.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0xFE,
        (
            "*sigh* Guess I've got to go and\x01",
            "get the parts myself.\x02",
        )
    )
    ...
    ChrTalk(    #4
        0xFE,
        (
            "I think I can finish this up\x01",
            "on my own.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0xFE,
        (
            "How'd it go? Did you get in touch\x01",
            "with Prometheus?\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        (
            "\x07\x05Estelle told Bruno about Prometheus no longer\x01",
            "being in charge of the haulage vehicle.\x02",
        )
    )
    ...
    ChrTalk(    #11
        0xFE,
        "I'm sorry I wasted your time.\x02",
    )
    ...
    ChrTalk(    #13
        0xFE,
        (
            "All right then, have a safe\x01",
            "trip to Elmo.\x02",
        )
    )
    ...
    ChrTalk(    #14
        0xFE,
        (
            "Hmm... It's gotta be the engine.\x01",
            "Nothing else would make sense.\x02",
        )
    )
    ...
    ChrTalk(    #15
        0xFE,
        (
            "I'm going to have to take a\x01",
            "closer look.\x02",
        )
    )
    ...
    ChrTalk(    #16
        0xFE,
        (
            "If you've got some time, I wonder\x01",
            "if you could get in touch with\x01",
            "Prometheus.\x02",
        )
    )
    ...
    ChrTalk(    #17
        0xFE,
        (
            "He should be in Operations,\x01",
            "on the third floor of the\x01",
            "central factory.\x02",
        )
    )
    ...
    ChrTalk(    #18
        0x106,
        (
            "#050FIt's the other way.\x02\x03",

            "At any rate, we've got to get\x01",
            "back to Zeiss.\x02",
        )
    )
    ...
    ChrTalk(    #19
        0x106,
        (
            "#050FHey, that's the wrong way!\x02\x03",
    ...
    AnonymousTalk(    #22
        "\x07\x00Found \x07\x02Black Bangle\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #23
        (
            "\x07\x00Found \x07\x02Black Bangle\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Black Bangle\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #24
        "\x07\x05I feel so...empty inside...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #26
        "\x07\x05Exterminated monster on the Tratt Plains Road!\x02",
    )
