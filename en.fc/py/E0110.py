...
def main():
    ...
    ChrTalk(    #0
        0x9,
        (
            "#210FThe temperature outside is 69.8\x01",
            "degrees with 15% humidity.\x02\x03",

            "There is a south-southwest wind\x01",
            "blowing at a speed of 12 arge.\x02\x03",

            "There are no orbal reactions in the\x01",
    ...
    ChrTalk(    #1
        0x8,
        (
            "#200FIt looks like the army isn't\x01",
            "patrolling here.\x02\x03",

            "Activate the orbal engine and begin\x01",
            "transmitting orbal energy to each\x01",
            "section of the airship.\x02",
        )
    )
    ...
    ChrTalk(    #2
        0xA,
        "Aye, sir. Orbal engine activated.\x02",
    )
    ...
    ChrTalk(    #3
        0xA,
        (
            "Transmission of orbal energy to all\x01",
            "sections underway.\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x8,
        (
            "#200FSet the drive rate to 40% and\x01",
            "maintain cruising speed.\x02\x03",

            "However, make sure that we can switch\x01",
            "to battle speed at any time.\x02",
        )
    )
    ...
    ChrTalk(    #11
        0x9,
        (
            "#211FIt looks like we'll make it back\x01",
            "before morning.\x02",
        )
    )
    ...
    ChrTalk(    #12
        ...
        (
            ...
            "I'm ready for some serious shut eye\x01",
            "myself, but I've got to report to\x01",
            "Don first.\x02",
        )
    )
    ...
    ChrTalk(    #15
        0xC,
        "#1PNo, I didn't hear anything...\x02",
    )
    ...
    ChrTalk(    #16
        0xE,
        (
            "That's odd. I could have sworn it\x01",
            "came from below deck.\x02",
        )
    )
    ...
    ChrTalk(    #17
        0xE,
        (
            "Maybe it's just a mouse or\x01",
            "something...\x02",
        )
    )
    ...
    ChrTalk(    #18
        0xE,
        (
            "I'll have to clean up the place when\x01",
            "I can find some free time.\x02",
        )
    )
