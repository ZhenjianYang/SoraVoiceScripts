...
def main():
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05The chest is empty...but it wouldn't be\x01",
            "empty if you put something in it.\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(    #4
        "\x07\x00Found \x07\x02Beast Steak\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x00Found \x07\x02Beast Steak\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Beast Steak\x07\x00.\x02",
        )
    )
