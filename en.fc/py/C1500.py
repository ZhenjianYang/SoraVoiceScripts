...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05The chest has been cleaned out! Villainous!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #4
        "\x07\x00Found \x07\x02Pearl Earring\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x00Found \x07\x02Pearl Earring\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Pearl Earring\x07\x00.\x02",
        )
    )
