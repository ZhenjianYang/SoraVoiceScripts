...
def main():
    ...
    AnonymousTalk(    #0
        "\x07\x00Found \x07\x02Range 1\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #1
        (
            "\x07\x00Found \x07\x02Range 1\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Range 1\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #2
        "\x07\x05You have found the ultimate treasure...oxygen.\x07\x00\x02",
    )
