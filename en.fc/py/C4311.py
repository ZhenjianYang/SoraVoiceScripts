...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Erbe Blades\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Erbe Blades\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Erbe Blades\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        "\x07\x05Ask again later.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Valkyrie Dress\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Valkyrie Dress\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Valkyrie Dress\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #10
        "\x07\x05You came back! I knew you would!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #13
        "\x07\x05So, when do you plan on giving me my stuff back?\x07\x00\x02",
    )
