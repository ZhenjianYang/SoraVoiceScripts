...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Octavian Stave\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Octavian Stave\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Octavian Stave\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05It's...empty.\x01",
            "This is not entirely unexpected, right?\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Demi-Handers\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Demi-Handers\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Demi-Handers\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x05Say, haven't we met before?\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #9
        "\x07\x00Found \x07\x02Attack 3\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #10
        (
            "\x07\x00Found \x07\x02Attack 3\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Attack 3\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #11
        "\x07\x05Hmm... Still empty...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #13
        "\x07\x00Found \x07\x02Cavalier Killer\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #14
        (
            "\x07\x00Found \x07\x02Cavalier Killer\x07\x00 in chest.\x01",
            "Inventory full so gave up Cavalier Killer.\x02",
        )
    )
    ...
    AnonymousTalk(    #15
        "\x07\x05Way to be thorough, hero!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #18
        "\x07\x05Hahahaha...no.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #21
        "\x07\x05I'll be taking that back now, thank you.\x07\x00\x02",
    )
