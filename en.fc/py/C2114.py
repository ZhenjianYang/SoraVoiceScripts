...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05The clowns told me you'd be back...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #3
        "\x07\x00Found \x07\x02Hot Fried Chicken\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #4
        (
            "\x07\x00Found \x07\x02Hot Fried Chicken\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Hot Fried Chicken\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x05You seem to be laboring under the hope that something\x01",
            "else will magically appear in this empty chest.\x01",
            "Let me quash that for you right now.\x07\x00\x02",
        )
    )
