...
def main():
    ...
    ChrTalk(    #0
        0x101,
        "#508FAll right, we're closing in!\x02",
    )
    ...
    ChrTalk(    #1
        0x105,
        (
            "#040FThis craft is small and lightweight,\x01",
            "so we have the edge, it seems.\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x8,
        (
            "#666FDamn stubborn little...\x02\x03",
    ...
    ChrTalk(    #5
        0x101,
        (
            "#502FHah! That'll teach you not to\x01",
            "underestimate a bracer!\x02\x03",

            "#005FJoshua, flank him on the right!\x02",
        )
    )
    ...
    ChrTalk(    #7
        0x101,
        "#580FWhoa! How'd he get so fast?!\x02",
    )
    ...
    ChrTalk(    #8
        0x105,
        (
            "#042FThe wind is blowing towards\x01",
            "open water! It's catching his\x01",
            "sails and giving him a boost!\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x102,
        (
            "#012FNot good. At this rate, the yacht has a clear\x01",
            "advantage. We won't be able to catch up...\x02",
        )
    )
    ...
    ChrTalk(    #11
        0x8,
        (
            "#667FHa ha ha! It looks like Aidios\x01",
            "smiles on me today!\x02\x03",

            "I bid you farewell, brats!\x02",
        )
    )
    ...
    ChrTalk(    #12
        0x101,
        (
            "#005FYou've gotta be KIDDING!\x01",
            "We were so close!\x02",
        )
    )
    ...
    ChrTalk(    #13
        0x102,
        (
            "#013FHe's going to get away...\x02\x03",
    ...
    ChrTalk(    #16
        0x8,
        (
            "#664FAll right...getting away is all\x01",
            "well and good, but what now?\x02\x03",

            "I guess I have no choice but\x01",
            "to head for the Empire...\x02\x03",

            "#667FOr, if I lie low for a while,\x01",
            "maybe 'he'...\x02",
        )
    )
