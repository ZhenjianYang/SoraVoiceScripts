...
def main():
    ...
    ChrTalk(    #0
        ...
        (
            "#000FWow...\x01",
            "These stairs go on forever.\x02",
        )
    )
    ...
    ChrTalk(    #1
        0x107,
        (
            "#060FYeah, it's the emergency stairway.\x02\x03",

            "We're always told not to use it\x01",
            "unless it's absolutely necessary.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0x102,
        (
            "#010FExactly why is that a shame...?\x01",
            "Never mind. Don't answer that.\x02\x03",

            "Come on, let's go back\x01",
            "to the hallway.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x102,
        (
            "#010FI don't think these stairs are\x01",
            "meant to be used, except in\x01",
            "emergencies.\x02\x03",
