...
def main():
    ...
    ChrTalk(    #0
        0x102,
        (
            "#010FThe castle gate switch is in\x01",
            "the Royal Guard Room!\x02\x03",

            "Up the south stairway!\x02",
        )
    )
    ...
    ChrTalk(    #3
        0xA,
        (
            "#010FNo doubt about it...\x02\x03",

            "These tracks indicate someone's\x01",
            "been through here recently.\x02",
        )
    )
    ...
    ChrTalk(    #4
        0x8,
        (
            "#090FI hold the key to this room, but there\x01",
            "is a spare. It's likely that's what was\x01",
            "used to gain entry.\x02\x03",

            "It would seem that we\x01",
