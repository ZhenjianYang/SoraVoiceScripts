...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Daedalus Arm\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Daedalus Arm\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Daedalus Arm\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        "\x07\x05You've returned to the scene of the crime, I see.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Magesta\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Magesta\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Magesta\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #10
        "\x07\x05There is a note inside. It says, 'I saw what you did...'\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #13
        "\x07\x05This chest has been picked clean...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #16
        "\x07\x05Tooooooooo late...\x07\x00\x02",
    )
