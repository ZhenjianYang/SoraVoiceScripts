...
def main():
    ...
    AnonymousTalk(    #2
        (
            "\x07\x05The chest is empty but covered in scratches.\x01",
            "It spells out, 'Mr. Tiddles was here.'\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(    #4
        "\x07\x00Found \x07\x02EP 3\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x00Found \x07\x02EP 3\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02EP 3\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #6
        "\x07\x05Found: Nada. Zilch. Zero.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #8
        "\x07\x00Found \x07\x02G-Impact\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #9
        (
            "\x07\x00Found \x07\x02G-Impact\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02G-Impact\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #10
        (
            ...
            "What depraved individual would do something like this?!\x07\x00\x02",
        )
    )
