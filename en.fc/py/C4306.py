...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Thor's Hammer\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Thor's Hammer\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Thor's Hammer\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Atlas Gear\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Atlas Gear\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Atlas Gear\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x05An empty chest! Scandalous!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #16
        "\x07\x05You have found the ultimate treasure...air.\x07\x00\x02",
    )
