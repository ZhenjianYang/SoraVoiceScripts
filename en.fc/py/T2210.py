...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_744",          # 04, 4
        "Function_5_F03",          # 05, 5
        "Function_6_16C9",         # 06, 6
        "Function_7_26FE",         # 07, 7
        "Function_8_2D95",         # 08, 8
        "Function_9_3213",         # 09, 9
        "Function_10_3537",        # 0A, 10
        "Function_11_3632",        # 0B, 11
        "Function_12_3ED3",        # 0C, 12
        "Function_13_6AF3",        # 0D, 13
        "Function_14_7FD7",        # 0E, 14
        "Function_15_800C",        # 0F, 15
        "Function_16_8046",        # 10, 16
        "Function_17_8080",        # 11, 17
        "Function_18_80B8",        # 12, 18
        "Function_19_8153",        # 13, 19
        "Function_20_81C7",        # 14, 20
        "Function_21_8243",        # 15, 21
        "Function_22_8275",        # 16, 22
        "Function_23_827F",        # 17, 23
        "Function_24_8289",        # 18, 24
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_DC9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_EFF")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E78")
    OP_A2(0x0)
    ...
    def Function_5_F03(): pass

    label("Function_5_F03")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_10AB")
    TalkBegin(0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_FF8")
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x4)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_13F7")
    TalkBegin(0x10)
    ...
    AnonymousTalk(    #14
        (
            "\x07\x00'That which nests here is a beast more dire than\x01",
    ...
    AnonymousTalk(    #15
        (
            "\x07\x00'Look to the three-eyed giant which towers over\x01",
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x4)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1415")
    Call(1, 0)
    Jump("loc_16C8")
    ...
    TalkBegin(0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_153B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_14C0")
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_15EE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_16C5")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_168F")
    OP_A2(0x1)
    ...
    def Function_6_16C9(): pass

    label("Function_6_16C9")

    TalkBegin(0xC)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_21B7")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x4)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x1, 0x200)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2087")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x1, 0x400)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2007")
    EventBegin(0x0)
    Fade(1000)
    ...
    QueueWorkItem(0x105, 1, lambda_1925)
    ...
    QueueWorkItem(0x105, 1, lambda_19D2)
    ...
    QueueWorkItem(0xC, 1, lambda_1A02)
    ...
    QueueWorkItem(0x105, 1, lambda_1FA0)
    OP_8C(0x101, 0, 400)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x4)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_214A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_2291")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_223D")
    OP_A2(0x2)

    ChrTalk(    #52
        0xFE,
        "Hmm hmm hmm...la la la...♪\x02",
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_2396")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_233F")
    OP_A2(0x2)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_2499")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_2624")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_258D")
    OP_A2(0x2)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 7)), scpexpr(EXPR_END)), "loc_2663")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_26FA")
    ...
    def Function_7_26FE(): pass

    label("Function_7_26FE")

    TalkBegin(0xD)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_28E5")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_283B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_27C5")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_292F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_29EE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_2A78")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2A59")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_2CA4")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2C0A")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 7)), scpexpr(EXPR_END)), "loc_2D42")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_2D91")
    ...
    def Function_8_2D95(): pass

    label("Function_8_2D95")

    TalkBegin(0x12)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_2E4A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_2ED6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_3040")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_2F8D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_30C9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_3170")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 7)), scpexpr(EXPR_END)), "loc_31A7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_320F")
    ...
    def Function_9_3213(): pass

    label("Function_9_3213")

    TalkBegin(0x13)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_32AD")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_3316")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_33A0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_341D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_34C8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_3533")
    ...
    def Function_10_3537(): pass

    label("Function_10_3537")
    ...
    QueueWorkItem(0xC, 1, lambda_36EC)
    ...
    QueueWorkItem(0xC, 1, lambda_3AD7)
    ...
    QueueWorkItem(0x105, 1, lambda_3AFD)
    ...
    QueueWorkItem2(0x102, 1, lambda_3B0B)
    ...
    def Function_12_3ED3(): pass

    label("Function_12_3ED3")
    ...
    QueueWorkItem(0xA, 1, lambda_43F5)
    ...
    QueueWorkItem(0x102, 1, lambda_4D6E)

    def lambda_4D7C():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_4D7C)
    OP_20(0x3E8)
    Sleep(1000)
    OP_1D(0x51)
    ...
    QueueWorkItem(0xB, 1, lambda_52BC)

    def lambda_52CA():
        OP_8C(0xFE, 135, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_52CA)
    ...
    QueueWorkItem2(0x102, 1, lambda_52D8)
    ...
    QueueWorkItem2(0x105, 1, lambda_52E9)
    Sleep(200)
    ...
    QueueWorkItem2(0x101, 1, lambda_52FF)
    SetChrFlags(0x9, 0x4)
    ...
    ChrTalk(    #203
        ...
        (
            ...
            "#147FThat's it in a nutshell. ㈱\x02",
        )
    )
    ...
    QueueWorkItem(0xB, 1, lambda_5578)

    def lambda_5586():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_5586)

    def lambda_5594():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_5594)

    def lambda_55A2():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_55A2)
    SetChrSubChip(0xA, 0)
    ...
    AnonymousTalk(    #229
        (
            "\x07\x05Kloe looked Mayor Dalmore directly in the eyes, her expression cold and\x01",
            "stern.\x02",
        )
    )
    ...
    QueueWorkItem(0xA, 1, lambda_62EB)
    ...
    QueueWorkItem(0x8, 1, lambda_63CB)

    def lambda_63E3():
        OP_6C(291000, 4000)
        ExitThread()

    QueueWorkItem(0x8, 3, lambda_63E3)

    def lambda_63F3():
        OP_6B(3100, 2000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_63F3)
    OP_1D(0x56)
    ...
    QueueWorkItem(0x8, 2, lambda_66A6)

    def lambda_66BE():
        OP_6C(315000, 1000)
        ExitThread()

    QueueWorkItem(0x8, 3, lambda_66BE)

    def lambda_66CE():
        OP_6B(2800, 800)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_66CE)
    SetChrChipByIndex(0xE, 6)
    ...
    QueueWorkItem(0x101, 1, lambda_68C7)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 1, lambda_68E2)
    Sleep(100)
    ...
    QueueWorkItem(0x105, 1, lambda_68FD)
    ...
    QueueWorkItem(0xE, 1, lambda_6A75)
    Sleep(150)
    ...
    QueueWorkItem(0xF, 1, lambda_6AAD)
    Sleep(400)
    Battle(0x394, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_6AE3"),
        (SWITCH_DEFAULT, "loc_6AE6"),
    )
    ...
    # Function_12_3ED3 end

    def Function_13_6AF3(): pass

    label("Function_13_6AF3")
    ...
    QueueWorkItem(0x8, 1, lambda_6EA3)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 3, lambda_6EC3)
    ...
    QueueWorkItem(0x101, 1, lambda_6EEB)
    ...
    QueueWorkItem(0x105, 1, lambda_6F21)
    Sleep(600)
    OP_22(0xC5, 0x0, 0x64)
    OP_44(0x8, 0xFF)
    ...
    QueueWorkItem(0x101, 2, lambda_737B)
    ...
    QueueWorkItem(0x102, 1, lambda_75C6)
    ...
    QueueWorkItem(0x101, 2, lambda_781C)
    ...
    QueueWorkItem(0x101, 1, lambda_7B80)

    def lambda_7B8E():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_7B8E)

    def lambda_7B9C():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_7B9C)
    ...
    QueueWorkItem2(0x101, 1, lambda_7CEA)
    ...
    QueueWorkItem2(0x102, 1, lambda_7CFB)
    ...
    QueueWorkItem2(0x105, 1, lambda_7D0C)
    ...
    QueueWorkItem(0x8, 1, lambda_7F00)
    ...
    QueueWorkItem(0x8, 1, lambda_7F27)
    ...
    # Function_13_6AF3 end

    def Function_14_7FD7(): pass

    label("Function_14_7FD7")
    ...
    # Function_14_7FD7 end

    def Function_15_800C(): pass

    label("Function_15_800C")
    ...
    # Function_15_800C end

    def Function_16_8046(): pass

    label("Function_16_8046")
    ...
    # Function_16_8046 end

    def Function_17_8080(): pass

    label("Function_17_8080")
    ...
    # Function_17_8080 end

    def Function_18_80B8(): pass

    label("Function_18_80B8")
    ...
    QueueWorkItem(0xFE, 0, lambda_8115)
    ...
    # Function_18_80B8 end

    def Function_19_8153(): pass

    label("Function_19_8153")
    ...
    # Function_19_8153 end

    def Function_20_81C7(): pass

    label("Function_20_81C7")
    ...
    # Function_20_81C7 end

    def Function_21_8243(): pass

    label("Function_21_8243")

    OP_77(0xCD, 0xED, 0xF0, 0x0, 0x0)

    label("loc_824C")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_8274")
    ...
    # Function_21_8243 end

    def Function_22_8275(): pass

    label("Function_22_8275")

    NewScene("ED6_DT01/T2210   ._SN", 123, 1, 0)
    IdleLoop()
    Return()

    # Function_22_8275 end

    def Function_23_827F(): pass

    label("Function_23_827F")

    NewScene("ED6_DT01/T2210   ._SN", 121, 1, 0)
    IdleLoop()
    Return()

    # Function_23_827F end

    def Function_24_8289(): pass

    label("Function_24_8289")
