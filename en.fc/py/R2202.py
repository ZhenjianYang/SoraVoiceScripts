...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_633",          # 03, 3
        "Function_4_F1C",          # 04, 4
        "Function_5_13B3",         # 05, 5
        "Function_6_140B",         # 06, 6
        "Function_7_146C",         # 07, 7
        "Function_8_16C0",         # 08, 8
        "Function_9_190F",         # 09, 9
        "Function_10_1A6D",        # 0A, 10
        "Function_11_1BA9",        # 0B, 11
    )
    ...
    ChrTalk(    #0
        0x102,
        "#010FWell, I guess this is goodbye.\x02",
    )
    ...
    ChrTalk(    #1
        ...
        (
            ...
            "#048FThank you so much for the last\x01",
            "few days.\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x101,
        (
            "#001FHa ha ha... No problem.\x01",
            "It's been fun!\x02\x03",

            "#006FTake care...and say hi to Matron\x01",
            "Theresa and the kids for us.\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x102,
        "#014FYou're from Manoria, aren't you...?\x02",
    )
    ...
    ChrTalk(    #7
        0x8,
        (
            "#1PYou guys are *huff* *huff* bracers,\x01",
            "right?\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x101,
        "#002FWhat kind of 'big trouble'?\x02",
    )
    ...
    ChrTalk(    #11
        0x8,
        (
            "#1PH-Hang on a sec...\x01",
            "I need to catch my breath...\x02",
        )
    )
    ...
    ChrTalk(    #14
        0x8,
        (
            "#1PSomeone attacked Matron Theresa\x01",
            "and the kids near Manoria.\x02",
        )
    )
    ...
    ChrTalk(    #18
        0x102,
        (
            "#012FKeep your cool... This is no time\x01",
            "to go fainting on us.\x02",
        )
    )
    ...
    ChrTalk(    #20
        0x105,
        (
            "#043F#4PPlease...tell us whatever you\x01",
            "can.\x02",
        )
    )
    ...
    ChrTalk(    #22
        0x8,
        (
            "They were apparently assaulted by\x01",
            "some strange group on the way back\x01",
            "from the campus festival.\x02",
        )
    )
    ...
    ChrTalk(    #23
        0x8,
        (
            "The kids are okay, but Matron Theresa\x01",
            "and that bracer lady got knocked out.\x02",
        )
    )
    ...
    ChrTalk(    #25
        0x102,
        "#012FThey must have been highly trained...\x02",
    )
    ...
    ChrTalk(    #27
        0x8,
        (
            "I would have contacted the guild,\x01",
            "but communications are down at\x01",
            "the inn.\x02",
        )
    )
    ...
    ChrTalk(    #28
        0x8,
        (
            "I didn't have much choice other\x01",
            "than to run all the way here.\x02",
        )
    )
    ...
    ChrTalk(    #29
        0x102,
        (
            "#015FI see... Well, thank you for your\x01",
            "help.\x02\x03",

            "#012FIf you can manage it, would you\x01",
            "go on to Ruan for us?\x02\x03",

            "We've got to hurry to Manoria.\x02",
        )
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_13B2")
    OP_A2(0x43E)
    EventBegin(0x0)
    FadeToDark(500, 0, -1)
    OP_0D()
    ...
    ChrTalk(    #36
        0x105,
        (
            "#040FWell, are you two going to the\x01",
            "guild?\x02\x03",

            "I just remembered something I need\x01",
            "to do...so can you go on ahead\x01",
            "without me?\x02\x03",

            "I'll catch up to you shortly.\x02",
        )
    )
    ...
    ChrTalk(    #37
        0x102,
        (
            "#014FThat's fine. Are you going back\x01",
            "to campus, then?\x02",
        )
    )
    ...
    ChrTalk(    #38
        ...
        (
            ...
            "I think I should report in\x01",
            "to the headmaster, and let\x01",
            "him know what's happening.\x02",
        )
    )
    ...
    ChrTalk(    #39
        0x101,
        (
            "#006FHm...okay, I got it!\x02\x03",

            "We'll be waiting for you at the guild!\x02",
        )
    )
    ...
    QueueWorkItem(0x101, 1, lambda_11ED)
    OP_8C(0x102, 180, 400)
    ...
    QueueWorkItem(0x102, 1, lambda_120F)
    ...
    ChrTalk(    #40
        0x105,
        "#049F#4PI'm sorry, Estelle...you too, Joshua.\x02",
    )
    ...
    AnonymousTalk(    #41
        "\x07\x05Kloe produced a notepad and pen and began scribbling furiously.\x02",
    )
    ...
    ChrTalk(    #42
        0x105,
        "#047F#4PThis ought to do it.\x02",
    )
    ...
    def Function_5_13B3(): pass

    label("Function_5_13B3")
    ...
    def Function_6_140B(): pass

    label("Function_6_140B")
    ...
    def Function_7_146C(): pass

    label("Function_7_146C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_1478")
    Call(0, 8)
    Return()
    ...
    AnonymousTalk(    #47
        "\x07\x05Exterminated monster on Gull Seaside Way!\x02",
    )
    ...
    def Function_8_16C0(): pass

    label("Function_8_16C0")
    ...
    AnonymousTalk(    #49
        "\x07\x05Exterminated second monster on Gull Seaside Way!\x02",
    )
    ...
    def Function_9_190F(): pass

    label("Function_9_190F")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x97, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_19FE")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_1985")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    FadeToBright(300, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    AnonymousTalk(    #52
        (
            "\x07\x05You can take my contents, but you'll\x01",
            "never take MY FREEEEDOOOOOM!\x07\x00\x02",
        )
    )
    ...
    def Function_10_1A6D(): pass

    label("Function_10_1A6D")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B5C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_1AE3")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #55
        "\x07\x05I...I feel so...empty inside...\x07\x00\x02",
    )
    ...
    # Function_10_1A6D end

    def Function_11_1BA9(): pass

    label("Function_11_1BA9")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1D7A")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1CA7")
    ...
    QueueWorkItem(0xB, 1, lambda_1BF8)

    def lambda_1C13():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_1C13)
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1C5C")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xF9, 1)"), scpexpr(EXPR_END)), "loc_1CFF")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)

    AnonymousTalk(    #57
        "\x07\x00Found \x07\x02Battle Suit\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #58
        (
            "\x07\x00Found \x07\x02Battle Suit\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Battle Suit\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #59
        "\x07\x05The voices in my lid said you'd return.\x07\x00\x02",
    )
