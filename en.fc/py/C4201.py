...
def main():
    ...
    AnonymousTalk(    #0
        "\x07\x05The lever won't budge.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #1
        "\x07\x05A group of vicious monsters are prowling around.\x02",
    )
    ...
    AnonymousTalk(    #2
        "\x07\x05Exterminated monsters in Grancel Sewers - West Block! \x02",
    )
    ...
    AnonymousTalk(    #4
        "\x07\x05Exterminated monster in Grancel Sewers - East Block! \x02",
    )
    ...
    AnonymousTalk(    #6
        "\x07\x00Found \x07\x02Reflector\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #7
        (
            "\x07\x00Found \x07\x02Reflector\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Reflector\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #8
        "\x07\x05You guessed it. It's empty.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #10
        "\x07\x00Found \x07\x02Cestus\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #11
        (
            "\x07\x00Found \x07\x02Cestus\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Cestus\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #12
        "\x07\x05You look...familiar...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #15
        "\x07\x05I say, didn't you loot me once before already?\x07\x00\x02",
    )
