...
def main():
    ...
    BuildStringList(
        ...
        'Sieg',                                 # 10
        'Colonel Richard',                      # 11
        '2nd Lieutenant Lorence',               # 12
        'Carna',                                # 13
        'Anelace',                              # 14
        'Grant',                                # 15
        'Kurt',                                 # 16
        '1st Lieutenant Schwarz',               # 17
        'Royal Guardsman',                      # 18
        'Royal Guardsman',                      # 19
        'Royal Guardsman',                      # 20
        'Royal Guardsman',                      # 21
        ...
        'Royal Guardsman',                      # 24
        'Royal Guardsman',                      # 25
        'Special Ops Frigate Shadow',           # 26
        'Special Ops Frigate',                  # 27
    ...
    ScpFunction(
        ...
        "Function_2_679",          # 02, 2
        "Function_3_ED1",          # 03, 3
        "Function_4_11FD",         # 04, 4
        "Function_5_1261",         # 05, 5
        "Function_6_12C5",         # 06, 6
        "Function_7_1329",         # 07, 7
        "Function_8_138D",         # 08, 8
        "Function_9_13DF",         # 09, 9
        "Function_10_1448",        # 0A, 10
        "Function_11_14A3",        # 0B, 11
        "Function_12_179B",        # 0C, 12
        "Function_13_17E3",        # 0D, 13
        "Function_14_1813",        # 0E, 14
        "Function_15_1843",        # 0F, 15
        "Function_16_1873",        # 10, 16
        "Function_17_18A3",        # 11, 17
        "Function_18_18D3",        # 12, 18
        "Function_19_1903",        # 13, 19
        "Function_20_1933",        # 14, 20
        "Function_21_1963",        # 15, 21
        "Function_22_1993",        # 16, 22
        "Function_23_19C3",        # 17, 23
        "Function_24_19F3",        # 18, 24
        "Function_25_1A23",        # 19, 25
        "Function_26_1A63",        # 1A, 26
        "Function_27_1AB3",        # 1B, 27
    )
    ...
    ChrTalk(    #3
        0x8,
        (
            "#043F#6PI'll be all right. I want you to\x01",
            "go back to see to Julia.\x02\x03",

            "I can't bear to just leave her...\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x8,
        (
            "#042FIt's just like she said... Security\x01",
            "is much lighter this way.\x02\x03",

            "I have to get to the Bracer Guild\x01",
            "quickly...\x02",
        )
    )
    ...
    ChrTalk(    #7
        ...
        (
            ...
            "#049FIsn't now around when Estelle\x01",
            "and Joshua were supposed to\x01",
            "arrive in town...?\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x8,
        (
            "#046FThe Intelligence Division's Special Ops\x01",
            "vessel...\x02\x03",

            "They're actually operating in\x01",
            "broad daylight...?!\x02",
        )
    )
    ...
    NpcTalk(    #12
        0xA,
        "Man's Voice",
        "#4PWhy, fancy meeting you here.\x02",
    )
    ...
    ChrTalk(    #13
        0xA,
        (
            "#115FKloe Rinz... Enrolled in the\x01",
            "social studies program at\x01",
            "Jenis Royal Academy...\x02\x03",

            "#111FIf I could have a quick word\x01",
            "with you...?\x02",
        )
    )
    ...
    def Function_3_ED1(): pass

    label("Function_3_ED1")
    ...
    QueueWorkItem(0x19, 2, lambda_F48)

    def lambda_F63():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1D4C, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_F63)
    Sleep(3000)
    ...
    QueueWorkItem(0x19, 2, lambda_F83)

    def lambda_F9E():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1964, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_F9E)

    def lambda_FB9():
        OP_8C(0x19, 0, 5)
        ExitThread()

    QueueWorkItem(0x19, 0, lambda_FB9)

    def lambda_FC7():
        OP_8C(0x1A, 0, 5)
        ExitThread()

    QueueWorkItem(0x1A, 0, lambda_FC7)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_100F)

    def lambda_102A():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_102A)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_104A)

    def lambda_1065():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_1065)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_1085)

    def lambda_10A0():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_10A0)
    Sleep(1000)
    ...
    def Function_4_11FD(): pass

    label("Function_4_11FD")
    ...
    def Function_6_12C5(): pass

    label("Function_6_12C5")
    ...
    def Function_7_1329(): pass

    label("Function_7_1329")
    ...
    QueueWorkItem(0x1, 1, lambda_13AC)
    ...
    def Function_9_13DF(): pass

    label("Function_9_13DF")
    ...
    def Function_10_1448(): pass

    label("Function_10_1448")
    ...
    # Function_10_1448 end

    def Function_11_14A3(): pass

    label("Function_11_14A3")
    ...
    QueueWorkItem(0x10, 2, lambda_168F)

    def lambda_16A7():
        OP_6E(405, 6500)
        ExitThread()

    QueueWorkItem(0xD, 3, lambda_16A7)
    Sleep(2500)
    ...
    QueueWorkItem(0x10, 3, lambda_16BC)

    def lambda_16D4():
        OP_6C(314000, 5000)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_16D4)
    Sleep(5100)
    ...
    QueueWorkItem(0x10, 2, lambda_16E9)

    def lambda_1701():
        OP_67(0, 4320, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x10, 3, lambda_1701)
    Sleep(4000)
    ...
    ChrTalk(    #14
        0x10,
        (
            "#178F#5PAll right...\x01",
            "Everyone, hold your positions.\x02\x03",

            "We will make our charge when the noon bell\x01",
            "rings.\x02",
        )
    )
    ...
    # Function_11_14A3 end

    def Function_12_179B(): pass

    label("Function_12_179B")
    ...
    def Function_15_1843(): pass

    label("Function_15_1843")
    ...
    # Function_15_1843 end

    def Function_16_1873(): pass

    label("Function_16_1873")
    ...
    # Function_16_1873 end

    def Function_17_18A3(): pass

    label("Function_17_18A3")
    ...
    # Function_17_18A3 end

    def Function_18_18D3(): pass

    label("Function_18_18D3")
    ...
    # Function_18_18D3 end

    def Function_19_1903(): pass

    label("Function_19_1903")
    ...
    # Function_19_1903 end

    def Function_20_1933(): pass

    label("Function_20_1933")
    ...
    # Function_20_1933 end

    def Function_21_1963(): pass

    label("Function_21_1963")
    ...
    # Function_21_1963 end

    def Function_22_1993(): pass

    label("Function_22_1993")
    ...
    # Function_22_1993 end

    def Function_23_19C3(): pass

    label("Function_23_19C3")
    ...
    # Function_23_19C3 end

    def Function_24_19F3(): pass

    label("Function_24_19F3")
    ...
    # Function_24_19F3 end

    def Function_25_1A23(): pass

    label("Function_25_1A23")
    ...
    # Function_25_1A23 end

    def Function_26_1A63(): pass

    label("Function_26_1A63")
    ...
    # Function_26_1A63 end

    def Function_27_1AB3(): pass

    label("Function_27_1AB3")
