...
def main():
    ...
    ChrTalk(    #1
        0x101,
        (
            "#008FThat scared the living daylights\x01",
            "out of me! What's the deal with\x01",
            "the slide?\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x102,
        (
            "#010FLooks like some kind\x01",
            "of secret waterway.\x02\x03",

            "Come on, let's catch up!\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x101,
        (
            "#506FSorry, we just got into a conversation\x01",
            "about my dad.\x02",
        )
    )
    ...
    ChrTalk(    #7
        0x102,
        (
            "#012FSorry for the hold-up. You\x01",
            "can go ahead and take off.\x02",
        )
    )
