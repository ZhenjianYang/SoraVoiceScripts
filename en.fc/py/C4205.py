...
def main():
    ...
    AnonymousTalk(    #0
        "\x07\x05Beyond the door is a stone wall, blocking the way.\x07\x00\x02",
    )
    ...
    ChrTalk(    #1
        0x104,
        (
            "#033FWhoops... I guess this is\x01",
            "the end of the line?\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x102,
        (
            "#012FYes, but there's a hidden door here.\x01",
            "There's a switch to activate it.\x02",
        )
    )
    ...
    ChrTalk(    #3
        0x108,
        (
            "#070FHmm... We should probably stay\x01",
            "on standby until noon.\x02",
        )
    )
    ...
    Menu(
        ...
        0,
        (
            "[Wait on standby]\x01",        # 0
            "[Do something else]\x01",      # 1
        )
    )
    ...
    ChrTalk(    #5
        ...
        (
            "#072FAll right...\x01",
            "We'll wait here.\x02\x03",

            "When the time comes,\x01",
            "we'll go in.\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x104,
        (
            "#035FOh, well... I guess we should\x01",
            "just rest until then.\x02",
        )
    )
    ...
    AnonymousTalk(    #8
        "\x07\x00Found \x07\x02Cloak\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #9
        (
            "\x07\x00Found \x07\x02Cloak\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Cloak\x07\x00.\x02",
        )
    )
