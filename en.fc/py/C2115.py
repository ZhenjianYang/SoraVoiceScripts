...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Flamberge\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Flamberge\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Flamberge\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05Hey, close my lid!\x01",
            "What, were you born in a barn?!\x07\x00\x02",
        )
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Scent\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Scent\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Scent\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x05Not YOU again!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #13
        "\x07\x00Found \x07\x02Army Boots\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #14
        (
            "\x07\x00Found \x07\x02Army Boots\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Army Boots\x07\x00.\x02",
        )
    )
