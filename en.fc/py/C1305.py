...
def main():
    ...
    ChrTalk(    #0
        ...
        (
            ...
            "I can hear someone talking on the\x01",
            "other side of the door.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x102,
        (
            "#012FIt sounds like some of the grunts...\x01",
    ...
    ChrTalk(    #6
        0x8,
        (
            "Crap, it looks like we've got\x01",
            "company...\x02",
        )
    )
    ...
    ChrTalk(    #7
        0x9,
        (
            "Don't think you're going to walk out\x01",
            "of here the same way you came in!\x02",
        )
    )
    ...
    ChrTalk(    #8
        0x9,
        (
            "All we need to do is buy some\x01",
            "time for Don, Kyle, and Josette\x01",
            "to escape!\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x104,
        (
            "#030FTrying to shield your masters to\x01",
            "the bitter end, huh...?\x02\x03",

            "Though it's a ridiculous thing to do,\x01",
            "your spirit is admirable.\x02",
        )
    )
    ...
    ChrTalk(    #10
        0x103,
        (
            "#026FThen I wonder if beating them into\x01",
            "the ground might be a way to honor\x01",
            "their sacrifice...\x02\x03",

            "#024FLet's take them down!\x02",
        )
    )
    ...
    AnonymousTalk(    #11
        "\x07\x00Found \x07\x02Jeweled Ring\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #12
        (
            "\x07\x00Found \x07\x02Jeweled Ring\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Jeweled Ring\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #13
        "\x07\x05The chest is empty... How tragic...\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #14
        "\x07\x00Found \x07\x02Scorpion\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #15
        (
            "\x07\x00Found \x07\x02Scorpion\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Scorpion\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #16
        "\x07\x05The chest is already empty, you double-dipper!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #19
        (
            ...
            "Makes you wanna cry, doesn't it?\x07\x00\x02",
        )
    )
