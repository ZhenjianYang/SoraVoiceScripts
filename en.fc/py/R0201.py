...
def main():
    ...
    ChrTalk(    #0
        ...
        (
            ...
            "#010FAfter we report this one we\x01",
            "can start on the next.\x02",
        )
    )
    ...
    ChrTalk(    #1
        0x101,
        (
            "#001FSounds like a plan.\x02\x03",

            "#001FOn to the next one!\x02",
        )
    )
    ...
    AnonymousTalk(    #8
        "\x07\x05The chest is empty. ...Shocked?\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #11
        "\x07\x05The chest is empty. ...Surprised?\x07\x00\x02",
    )
