...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_233E",         # 07, 7
        "Function_8_2F7F",         # 08, 8
        "Function_9_4441",         # 09, 9
        "Function_10_5E7C",        # 0A, 10
    )
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_53A")
    OP_0D()
    ...
    ChrTalk(    #3
        0x8,
        (
            "#630FIt looks like there's nothing\x01",
    ...
    def Function_5_550(): pass

    label("Function_5_550")

    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_744")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6E5")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x67, 2)), scpexpr(EXPR_END)), "loc_8FB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x65, 3)), scpexpr(EXPR_END)), "loc_D36")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C61")
    OP_A2(0x36D)
    ...
    ChrTalk(    #17
        0x8,
        (
            "#630FWell, at least things have\x01",
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x63, 0)), scpexpr(EXPR_END)), "loc_F77")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EBC")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 7)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1109")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 5)), scpexpr(EXPR_END)), "loc_107B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_END)), "loc_11E8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_19C5")
    EventBegin(0x0)
    OP_A2(0x314)
    ClearMapFlags(0x1)
    Fade(1000)
    ...
    AnonymousTalk(    #26
        "\x07\x05Estelle relayed the information they had obtained from General Morgan.\x02",
    )
    ...
    ChrTalk(    #34
        0x103,
        (
            "#026FIn light of that, we should\x01",
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x61, 3)), scpexpr(EXPR_END)), "loc_1C6B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 1)), scpexpr(EXPR_END)), "loc_1D0F")
    ...
    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_1DE7")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 7)), scpexpr(EXPR_END)), "loc_1D8F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_215C")
    OP_A2(0x35F)
    OP_A2(0x1)
    ...
    def Function_7_233E(): pass

    label("Function_7_233E")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_250A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_24B6")
    OP_A2(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6C, 0)), scpexpr(EXPR_END)), "loc_2409")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6C, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_29F9")
    ...
    def Function_8_2F7F(): pass

    label("Function_8_2F7F")
    ...
    QueueWorkItem(0x101, 2, lambda_2FBA)
    Sleep(2000)
    OP_4A(0x8, 0)
    ...
    QueueWorkItem(0x103, 1, lambda_3068)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_3088)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_30A8)
    ...
    QueueWorkItem(0x102, 1, lambda_3FD4)
    Sleep(500)
    ...
    QueueWorkItem(0x1, 2, lambda_3FF4)
    ...
    QueueWorkItem(0x1, 1, lambda_4034)
    OP_8C(0x101, 0, 400)
    OP_8C(0x102, 0, 400)
    Sleep(500)
    ...
    AnonymousTalk(    #126
        "\x07\x05Estelle and Joshua filled out the registration transfer forms.\x02",
    )
    ...
    QueueWorkItem(0x1, 2, lambda_42EF)
    ...
    def Function_9_4441(): pass

    label("Function_9_4441")
    ...
    QueueWorkItem2(0x101, 1, lambda_4CE3)
    ...
    QueueWorkItem2(0x102, 1, lambda_4CF4)
    ...
    QueueWorkItem2(0x103, 1, lambda_4D05)
    ...
    QueueWorkItem2(0x104, 1, lambda_4D16)
    OP_8C(0xB, 180, 400)
    ...
    QueueWorkItem(0xB, 1, lambda_4D2E)
    Sleep(300)
    OP_8C(0xC, 180, 400)
    ...
    QueueWorkItem(0xC, 1, lambda_4D55)
    ...
    QueueWorkItem(0x104, 1, lambda_4F42)
    OP_8C(0x103, 270, 400)

    ChrTalk(    #153
        0x103,
        (
            "#027FHeh... If you say so.\x02\x03",
    ...
    QueueWorkItem(0x101, 3, lambda_5076)

    def lambda_508E():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_508E)

    def lambda_509C():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_509C)

    def lambda_50AA():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_50AA)
    TurnDirection(0x101, 0x8, 400)
    WaitChrThread(0x101, 0x3)
    Sleep(100)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x35, 0x0, 0x20)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_50E1")
    OP_AF(0x1C, 0x35)
    Sleep(100)
    OP_28(0x36, 0x4, 0x10)
    OP_28(0x36, 0x4, 0x20)
    ...
    QueueWorkItem(0x101, 3, lambda_558B)
    ...
    QueueWorkItem2(0x101, 1, lambda_55A3)
    ...
    QueueWorkItem2(0x102, 1, lambda_55B4)
    ...
    QueueWorkItem2(0x103, 1, lambda_55C5)
    ...
    QueueWorkItem2(0x104, 1, lambda_55D6)
    ...
    AnonymousTalk(    #181
        "\x07\x05Estelle was given both the letter and parcel.\x02",
    )
    ...
    QueueWorkItem2(0x101, 1, lambda_5BF4)
    ...
    QueueWorkItem2(0x102, 1, lambda_5C05)
    ...
    QueueWorkItem2(0x103, 1, lambda_5C16)
    ...
    QueueWorkItem2(0x104, 1, lambda_5C27)
    ...
    QueueWorkItem(0x101, 3, lambda_5D14)
    WaitChrThread(0x101, 0x3)
    ...
    QueueWorkItem(0x102, 1, lambda_5DDC)

    def lambda_5DEA():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_5DEA)
    ...
    def Function_10_5E7C(): pass

    label("Function_10_5E7C")
    ...
    AnonymousTalk(    #203
        "\x07\x05Estelle started by cutting the letter's seal.\x02",
    )
    ...
    AnonymousTalk(    #204
        "\x07\x05'Dear Estelle and Joshua,'\x02",
    )
    ...
    AnonymousTalk(    #205
        (
            "\x07\x05'I'm sure you're probably about\x01",
    ...
    AnonymousTalk(    #206
        (
            "\x07\x05'I'm also sure there are many things you'll have\x01",
    ...
    AnonymousTalk(    #207
        (
            "\x07\x05'Anyway, it turns out that I've had\x01",
    ...
    AnonymousTalk(    #208
        (
            "\x07\x05'And unfortunately, it looks like I\x01",
    ...
    AnonymousTalk(    #209
        (
            "\x07\x05'Please don't expect my return\x01",
    ...
    AnonymousTalk(    #210
        (
            "\x07\x05'I'm really sorry that things turned out like\x01",
    ...
    AnonymousTalk(    #211
        (
            "\x07\x05'So until I get back, I'll leave it\x01",
    ...
    AnonymousTalk(    #212
        (
            "\x07\x05'You're free to continue working\x01",
            "in Rolent...'\x02",
        )
    )
    ...
    AnonymousTalk(    #213
        (
            "\x07\x05'...or you're free to pursue qualifying\x01",
    ...
    AnonymousTalk(    #214
        (
            "\x07\x05'Your 16th year is a vintage time in\x01",
    ...
    AnonymousTalk(    #215
        (
            "\x07\x05'Please give my regards to\x01",
    ...
    AnonymousTalk(    #216
        "\x07\x05'-Cassius Bright'\x07\x05\x02",
    )
    ...
    ChrTalk(    #220
        0x104,
        (
            "#030F#5PThe queen's birthday celebration,\x01",
            "is it?\x02\x03",
    ...
    AnonymousTalk(    #231
        "\x07\x05Estelle opened the parcel from the unknown sender.\x02",
    )
    ...
    AnonymousTalk(    #232
        "\x07\x05Inside was a shiny, black hemispherical device.\x02",
    )

    CloseMessageWindow()

    AnonymousTalk(    #233
        "\x07\x05Also enclosed was a single memo with the item.\x02",
    )
    ...
    AnonymousTalk(    #236
        (
            "\x07\x05'I was able to secure the item the\x01",
    ...
    AnonymousTalk(    #237
        (
            "\x07\x05'Please ask Professor R to do an\x01",
    ...
    ChrTalk(    #248
        0x101,
        (
            "#582F#4P#3SGeez... Now look at what's happened\x01",
