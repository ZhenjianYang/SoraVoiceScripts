...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Arc Rod\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Arc Rod\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Arc Rod\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x05Double-dipping is against the rules.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #13
        "\x07\x05An empty chest is a tragic thing indeed.\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #16
        "\x07\x05It's empty! Treachery!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #28
        "\x07\x05It wouldn't be empty if you hadn't taken the stuff in it.\x07\x00\x02",
    )
