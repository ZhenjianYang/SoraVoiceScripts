...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_72F",          # 04, 4
        "Function_5_7BB",          # 05, 5
        "Function_6_1009",         # 06, 6
        "Function_7_1ACA",         # 07, 7
        "Function_8_1B93",         # 08, 8
        "Function_9_1C11",         # 09, 9
        "Function_10_1C16",        # 0A, 10
        "Function_11_2DF0",        # 0B, 11
        "Function_12_2DF5",        # 0C, 12
        "Function_13_93FE",        # 0D, 13
        "Function_14_B2DD",        # 0E, 14
        "Function_15_B336",        # 0F, 15
        "Function_16_BB51",        # 10, 16
        "Function_17_D648",        # 11, 17
        "Function_18_EA30",        # 12, 18
        "Function_19_F888",        # 13, 19
        "Function_20_F8D2",        # 14, 20
        "Function_21_F91C",        # 15, 21
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_1005")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_F11")
    ...
    def Function_6_1009(): pass

    label("Function_6_1009")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_10A8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 2)), scpexpr(EXPR_END)), "loc_1144")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_END)), "loc_1292")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_11D2")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_END)), "loc_1335")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_13DC")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 6)), scpexpr(EXPR_END)), "loc_146E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 1)), scpexpr(EXPR_END)), "loc_1478")
    Jump("loc_1AC6")

    label("loc_1478")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_END)), "loc_14F3")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 1)), scpexpr(EXPR_END)), "loc_16A6")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_15B7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 0)), scpexpr(EXPR_END)), "loc_1781")

    ChrTalk(    #51
        0xFE,
        (
            "The Guardians of Valleria Shore--those\x01",
            "are fish, not actual monarchs--\x01",
            "go into the deep when it gets cold out.\x02",
        )
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_1AC6")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_186D")

    ChrTalk(    #53
        0xFE,
        (
            "I've been chasin' Valleria's Guardians\x01",
            "the biggest kinds fish you ever done\x01",
            "seen--for roundabouts five years now.\x02",
        )
    )
    ...
    def Function_7_1ACA(): pass

    label("Function_7_1ACA")
    ...
    def Function_8_1B93(): pass

    label("Function_8_1B93")
    ...
    def Function_10_1C16(): pass

    label("Function_10_1C16")

    TalkBegin(0x12)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2237")
    OP_A2(0x67C)
    ...
    ChrTalk(    #71
        ...
        (
            ...
            "parts. We call them Guardians, an' they wriggle'\x01",
            "and they dive all through the waters of Liberl.\x02",
        )
    )
    ...
    ChrTalk(    #73
        0x101,
        (
            "#501FSo...you guys like fishing, then!\x02\x03",
    ...
    ChrTalk(    #76
        ...
        (
            ...
            "hold introductory seminars,\x01",
            "and sell our handmade gear.\x02",
        )
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_2387")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_22BB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_END)), "loc_2566")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_2480")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_END)), "loc_262A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_26D7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 6)), scpexpr(EXPR_END)), "loc_28DF")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_27B3")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 1)), scpexpr(EXPR_END)), "loc_2988")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_END)), "loc_2B41")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_2A33")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 1)), scpexpr(EXPR_END)), "loc_2C98")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_2BE2")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 0)), scpexpr(EXPR_END)), "loc_2D71")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_2DEC")
    ...
    # Function_10_1C16 end

    def Function_11_2DF0(): pass

    label("Function_11_2DF0")

    Call(0, 12)
    Return()

    # Function_11_2DF0 end

    def Function_12_2DF5(): pass

    label("Function_12_2DF5")

    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_314A")
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3139")
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x4B, 0x0, 0x10)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x4B, 0x0, 0x20)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2FFD")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_A9(0x63)"), scpexpr(EXPR_END)), "loc_3096")
    Sleep(200)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_314A")
    TalkEnd(0x8)
    Return()

    label("loc_314A")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_3383")
    EventBegin(0x0)
    ...
    AnonymousTalk(    #133
        (
            "\x07\x05Joshua explained everything they learned from the cathedral and the\x01",
            "Liberl News HQ.\x02",
        )
    )
    ...
    QueueWorkItem(0x101, 1, lambda_3BE4)

    def lambda_3BF2():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_3BF2)
    Sleep(400)
    ...
    QueueWorkItem(0x102, 1, lambda_416D)
    OP_8C(0x101, 90, 400)
    ...
    ChrTalk(    #160
        0x8,
        (
            "#764FHowever, I agree with Zin that trying to\x01",
    ...
    QueueWorkItem2(0x101, 1, lambda_4381)
    ...
    QueueWorkItem2(0x102, 1, lambda_4392)
    ...
    QueueWorkItem2(0x108, 1, lambda_43A3)
    ...
    QueueWorkItem2(0xB, 1, lambda_43B4)
    ...
    QueueWorkItem2(0x9, 1, lambda_43C5)
    ...
    QueueWorkItem2(0xC, 1, lambda_43D6)
    ...
    QueueWorkItem2(0xA, 1, lambda_43E7)

    def lambda_43F8():
        OP_8C(0xFE, 315, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_43F8)
    SetChrFlags(0x8, 0x4)
    ...
    QueueWorkItem(0x8, 2, lambda_440B)

    def lambda_4426():
        OP_8E(0xFE, 0x1D57E, 0x0, 0x132E, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_4426)
    ...
    QueueWorkItem2(0x8, 1, lambda_44C6)

    def lambda_44D7():
        OP_8E(0xFE, 0x1D47A, 0x0, 0xBF4, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_44D7)
    ...
    QueueWorkItem(0xA, 1, lambda_536F)
    ...
    QueueWorkItem(0xB, 1, lambda_5384)
    ...
    QueueWorkItem(0x9, 1, lambda_5605)

    def lambda_5613():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_5613)

    def lambda_5621():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_5621)

    def lambda_562F():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_562F)

    def lambda_563D():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_563D)

    def lambda_564B():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_564B)

    def lambda_5659():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_5659)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_6A5E")
    EventBegin(0x0)
    OP_A2(0x628)
    OP_28(0x48, 0x1, 0x80)
    Fade(1000)
    ...
    OP_8C(0x8, 90, 0)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_5BD1")
    ...
    ChrTalk(    #208
        ...
        (
            ...
            "We had Zin, along with Olivier's\x01",
    ...
    AnonymousTalk(    #212
        "\x07\x05Joshua explained the details of Nial's findings to Elnan.\x02",
    )
    ...
    AnonymousTalk(    #232
        "\x07\x00Received \x07\x02Grancel Sewer Key B\x07\x00.\x02",
    )
    ...
    ChrTalk(    #238
        ...
        (
            ...
            "We'll head on down with Zin and\x01",
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_7429")
    EventBegin(0x0)
    OP_A2(0x61F)
    ...
    AnonymousTalk(    #243
        "\x07\x05Joshua explained that there were sky bandits and Special Op teams.\x07\x00\x02",
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_7762")
    OP_A2(0x60A)
    ...
    QueueWorkItem(0x102, 1, lambda_7539)
    TurnDirection(0x101, 0x8, 400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_807A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 3)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_7EA8")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7DF4")
    OP_A2(0x6FD)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 2)), scpexpr(EXPR_END)), "loc_8266")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_815A")
    ...
    ChrTalk(    #288
        0x8,
        (
            "#762FJoshua! Zin! I'm glad to see\x01",
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_END)), "loc_8468")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 2)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_832C")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_END)), "loc_87B6")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_84D1")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_896A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_8883")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 0)), scpexpr(EXPR_END)), "loc_8AA5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 6)), scpexpr(EXPR_END)), "loc_8EF1")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_8E71")
    OP_A2(0x6FA)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 1)), scpexpr(EXPR_END)), "loc_902D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_8F71")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_END)), "loc_90C6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 1)), scpexpr(EXPR_END)), "loc_929B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_915E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 0)), scpexpr(EXPR_END)), "loc_939A")

    ChrTalk(    #316
        0x8,
        (
            "#760FZin is currently staying at\x01",
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_93FA")
    ...
    # Function_12_2DF5 end

    def Function_13_93FE(): pass

    label("Function_13_93FE")
    ...
    QueueWorkItem(0x8, 1, lambda_962F)

    def lambda_963D():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_963D)

    def lambda_964B():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_964B)

    def lambda_9659():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_9659)
    ...
    QueueWorkItem2(0x101, 1, lambda_9667)
    ...
    QueueWorkItem2(0x102, 1, lambda_9678)

    def lambda_9689():
        OP_8E(0xFE, 0xFFFFF97A, 0x0, 0xFFFFF7FE, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_9689)

    def lambda_96A4():
        OP_8E(0xFE, 0xFFFFFDC6, 0x0, 0xFFFFF8E4, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_96A4)
    ...
    QueueWorkItem(0x102, 1, lambda_977F)
    TurnDirection(0x101, 0x9, 400)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6C, 0)), scpexpr(EXPR_END)), "loc_984D")
    ...
    QueueWorkItem2(0x101, 1, lambda_9A1C)
    ...
    QueueWorkItem2(0x102, 1, lambda_9A2D)
    ...
    QueueWorkItem2(0x8, 1, lambda_9A3E)
    ...
    QueueWorkItem(0x101, 3, lambda_9BDB)

    def lambda_9BF3():
        OP_8E(0xFE, 0xFFFFF5E2, 0x0, 0x118, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_9BF3)
    ...
    QueueWorkItem2(0x101, 1, lambda_9C0E)
    ...
    QueueWorkItem(0x102, 2, lambda_9C3A)
    ...
    QueueWorkItem2(0x102, 1, lambda_9C55)
    ...
    AnonymousTalk(    #358
        (
            "\x07\x05Estelle and Joshua explained what they'd learned in Leiston Fortress, as well\x01",
    ...
    QueueWorkItem(0x102, 1, lambda_B267)
    TurnDirection(0x101, 0x8, 400)
    ...
    # Function_13_93FE end

    def Function_14_B2DD(): pass

    label("Function_14_B2DD")
    ...
    QueueWorkItem(0xFE, 3, lambda_B310)
    OP_8E(0xFE, 0xFFFFFF92, 0xFFFFFF06, 0xFFFFE43A, 0x7D0, 0x0)
    SetChrFlags(0xFE, 0x80)
    Return()

    # Function_14_B2DD end

    def Function_15_B336(): pass

    label("Function_15_B336")
    ...
    ChrTalk(    #388
        0x8,
        (
            "#760FI see. Yes, Zin requested the\x01",
    ...
    ChrTalk(    #389
        0x101,
        (
            "#506FHeheh... Nice to see his selfishness\x01",
    ...
    ChrTalk(    #394
        0x101,
        (
            "#000FGot'cha. Makes sense, since\x01",
    ...
    QueueWorkItem(0x102, 1, lambda_B86D)
    TurnDirection(0x101, 0x8, 400)
    ...
    # Function_15_B336 end

    def Function_16_BB51(): pass

    label("Function_16_BB51")
    ...
    QueueWorkItem(0x102, 1, lambda_BFC0)
    OP_8C(0x101, 90, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_CAF0)

    def lambda_CAFE():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_CAFE)
    ...
    # Function_16_BB51 end

    def Function_17_D648(): pass

    label("Function_17_D648")
    ...
    AnonymousTalk(    #464
        "\x07\x00Handed over \x07\x02letters of recommendation\x07\x00.\x02",
    )
    ...
    CloseMessageWindow()
    Sleep(400)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2F), scpexpr(EXPR_PUSH_LONG, 0x8), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DCC7")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2F), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DD42")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2F), scpexpr(EXPR_PUSH_LONG, 0x6), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DDBD")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2F), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DE54")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2F), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_DEEB")
    ...
    AnonymousTalk(    #474
        "\x07\x00Received \x07\x02Bracer Emblem\x07\x00.\x02",
    )
    ...
    QueueWorkItem(0x101, 1, lambda_E0C2)

    def lambda_E0D0():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_E0D0)
    ...
    QueueWorkItem(0x102, 1, lambda_E245)
    Sleep(100)
    OP_8C(0x101, 0, 400)
    ...
    QueueWorkItem(0x9, 1, lambda_E34D)

    def lambda_E35B():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_E35B)

    def lambda_E369():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_E369)

    def lambda_E377():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_E377)

    def lambda_E385():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_E385)

    def lambda_E393():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_E393)

    def lambda_E3A1():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_E3A1)

    def lambda_E3AF():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_E3AF)

    def lambda_E3BD():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_E3BD)

    def lambda_E3CB():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_E3CB)
    ...
    QueueWorkItem(0xE, 1, lambda_E4EF)

    def lambda_E4FD():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_E4FD)

    def lambda_E50B():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_E50B)

    def lambda_E519():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_E519)

    def lambda_E527():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_E527)
    Sleep(1000)
    ...
    QueueWorkItem(0x9, 1, lambda_E53A)

    def lambda_E548():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_E548)

    def lambda_E556():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_E556)

    def lambda_E564():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_E564)
    ...
    QueueWorkItem(0x101, 1, lambda_E8E4)
    OP_8C(0x11, 180, 400)
    ...
    QueueWorkItem(0xA, 1, lambda_E903)

    def lambda_E911():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_E911)

    def lambda_E91F():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_E91F)

    def lambda_E92D():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_E92D)
    ...
    # Function_17_D648 end

    def Function_18_EA30(): pass

    label("Function_18_EA30")
    ...
    QueueWorkItem(0x18, 1, lambda_EBB3)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 1, lambda_EF3F)

    def lambda_EF4D():
        TurnDirection(0xFE, 0x19, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_EF4D)

    def lambda_EF5B():
        TurnDirection(0xFE, 0x19, 400)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_EF5B)

    def lambda_EF69():
        TurnDirection(0xFE, 0x19, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_EF69)
    ...
    QueueWorkItem(0x19, 1, lambda_F057)

    def lambda_F069():
        OP_8E(0x19, 0xFFFFF8F8, 0x0, 0xFFFFF7F4, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x19, 2, lambda_F069)
    ...
    QueueWorkItem2(0x19, 0, lambda_F084)

    def lambda_F095():
        OP_6D(-2220, 0, -370, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_F095)
    ...
    QueueWorkItem2(0x101, 1, lambda_F0AD)
    ...
    QueueWorkItem2(0x102, 1, lambda_F0BE)
    ...
    QueueWorkItem2(0x18, 1, lambda_F0CF)
    WaitChrThread(0x101, 0x3)
    ...
    QueueWorkItem2(0x101, 1, lambda_F564)
    ...
    QueueWorkItem2(0x102, 1, lambda_F575)
    ...
    # Function_18_EA30 end

    def Function_19_F888(): pass

    label("Function_19_F888")
    ...
    QueueWorkItem(0xFE, 3, lambda_F8AC)
    OP_8F(0xFE, 0x21C, 0xFA, 0xFFFFE192, 0x7D0, 0x0)
    SetChrFlags(0xFE, 0x80)
    Return()

    # Function_19_F888 end

    def Function_20_F8D2(): pass

    label("Function_20_F8D2")
    ...
    QueueWorkItem(0xFE, 3, lambda_F8F6)
    OP_8F(0xFE, 0xFFFFFEAC, 0xFFFFFF06, 0xFFFFE192, 0x7D0, 0x0)
    SetChrFlags(0xFE, 0x80)
    Return()

    # Function_20_F8D2 end

    def Function_21_F91C(): pass

    label("Function_21_F91C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDD, 5)), scpexpr(EXPR_END)), "loc_F92F")
    OP_2A(0x50, 0x51, 0x55, 0xFFFF)
    Jump("loc_F9D1")

    label("loc_F92F")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_F975")
    FadeToDark(300, 0, 100)
    SetChrName("")
    SetMessageWindowPos(72, 320, 56, 3)

    AnonymousTalk(    #524
        "\x07\x05There are no requests.\x02",
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_F986")
    OP_2A(0x50, 0x51, 0xFFFF)
    Jump("loc_F9D1")

    label("loc_F986")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 1)), scpexpr(EXPR_END)), "loc_F995")
    OP_2A(0x50, 0xFFFF)
    Jump("loc_F9D1")
