...
def main():
    ...
    ChrTalk(    #7
        0x101,
        (
            "#000FJoshua, please be careful...\x02\x03",
    ...
    ChrTalk(    #9
        0x101,
        (
            "#000FI understand.\x02\x03",

            "Whatever happens,\x01",
            "remember our promise!\x02\x03",

            "We see each other again, safe\x01",
    ...
    ChrTalk(    #13
        0x1D,
        (
            "#020FAnd don't worry about Estelle.\x02\x03",

            "You've grown so much during\x01",
            "this trip of yours.\x02\x03",

            "Not just in your skills and bracer\x01",
    ...
    ChrTalk(    #16
        0x101,
        "#000FI-It's nothing! Save it for later!\x02",
    )
    ...
    ChrTalk(    #17
        0x108,
        (
            "#070FHa ha... Now, then...\x02\x03",

            "I think we'll be heading out.\x02",
        )
    )
    ...
    ChrTalk(    #18
        0x1E,
        "#030FMay we meet again, my lovelies.\x02",
    )
    ...
    ChrTalk(    #22
        0x1C,
        (
            "#040F(Ha ha... Yes, I suppose I have.)\x02\x03",

            "(They always have a smile\x01",
            "for each other...)\x02\x03",

            "(...I have to admit, I'm even\x01",
