...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Sylphen Boots\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Sylphen Boots\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Sylphen Boots\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        "\x07\x05The chest is empty. I wonder whose fault that is...?\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #5
        "\x07\x00Found \x07\x02Hauteclere\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x00Found \x07\x02Hauteclere\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Hauteclere\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #7
        "\x07\x05Back for more? Are you a hero or a scavenger?!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #11
        "\x07\x05It's empty?! Villainous!\x07\x00\x02",
    )
