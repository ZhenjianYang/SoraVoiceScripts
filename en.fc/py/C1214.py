...
def main():
    ...
    AnonymousTalk(    #0
        "\x07\x00Found \x07\x02Fried Eyes & Eggs\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #1
        (
            "\x07\x00Found \x07\x02Fried Eyes & Eggs\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Fried Eyes & Eggs\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #2
        "\x07\x05Limit: One per adventurer. -Dev Team\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #5
        "\x07\x05Don't touch it! It's EMPTY!\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #8
        "\x07\x05It's...empty... Curses!\x07\x00\x02",
    )
