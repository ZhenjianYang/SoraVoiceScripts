...
def main():
    ...
    ChrTalk(    #0
        0xD,
        (
            "#178FNow I understand just how\x01",
    ...
    ChrTalk(    #1
        ...
        (
            ...
            "#178FI've been training, just so I\x01",
            "wouldn't embarrass myself when\x01",
            "they came back.\x02",
        )
    )
    ...
    ChrTalk(    #4
        0x104,
        (
            "#030FWell, yes, I guess you could\x01",
            "call us that.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x108,
        "#070FI guess I can understand the sentiment.\x02",
    )
    ...
    ChrTalk(    #8
        0x104,
        "#030FNighty-night, kitty-cats...\x02",
    )
    ...
    ChrTalk(    #9
        0x102,
        (
            "#010FLet's see what we can do about\x01",
    ...
    ChrTalk(    #10
        0x108,
        (
            "#070FLeave it to us.\x02\x03",

            "No one's getting through here, or\x01",
    ...
    ChrTalk(    #11
        0x104,
        (
            "#030FHeh. And now's the time that\x01",
            "Heaven's Gate opens...\x02\x03",

            "Thus begins the final movement!\x02",
        )
    )
