...
def main():
    ...
    NpcTalk(    #3
        ...
        "Luke's Voice",
        (
            "#1SWe're only on the 1st floor\x01",
            "of this place...\x02",
        )
    )
    ...
    ChrTalk(    #4
        0x101,
        (
            "#505F#3PDid you hear that?!\x01",
            "They really did come in here...\x02\x03",
    ...
    ChrTalk(    #5
        0x102,
        "#014F#6PEstelle? Are you all right?\x02",
    )
    ...
    ChrTalk(    #7
        0x101,
        (
            "#005F#4S#3PIf you can hear me,\x01",
            "answer me NOW!\x02",
        )
    )
    ...
    ChrTalk(    #8
        0x101,
        (
            "#509F#3PThose little brats!\x01",
            "Are they pretending they\x01",
            "can't hear me?!\x02",
        )
    )
    ...
    ChrTalk(    #9
        0x102,
        (
            "#012F#6PThey might have climbed\x01",
            "up to the 2nd floor.\x02\x03",

            "#012FLet's hurry and see if we\x01",
            "can find them.\x02",
        )
    )
