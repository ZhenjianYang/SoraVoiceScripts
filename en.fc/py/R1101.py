...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AD8")
    OP_A2(0x305)
    OP_28(0x7, 0x4, 0x40)
    OP_28(0xC, 0x4, 0x40)
    ...
    ChrTalk(    #8
        0x101,
        (
            "#505FFirst Mr. Ashton and now him...\x01",
    ...
    def Function_4_AD9(): pass

    label("Function_4_AD9")
