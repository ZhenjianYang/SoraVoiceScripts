...
def main():
    ...
    ChrTalk(    #0
        0x101,
        (
            "#580FHey, check it out...\x02\x03",

            "Something about this spot feels\x01",
            "different from the other areas...\x02",
        )
    )
    ...
    ChrTalk(    #1
        0x107,
        (
            "#062FFeels like an orbal engine is\x01",
            "causing a buildup of pressure...\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x103,
        (
            "#022FThere's no wind, but I feel\x01",
            "some kind of pressure...\x02",
        )
    )
    ...
    ChrTalk(    #3
        ...
        (
            "#057FYeah...\x01",
            "It's almost hard to breathe.\x02",
        )
    )
    ...
    ChrTalk(    #4
        0x105,
        (
            "#047FI feel it... It's like some kind\x01",
            "of massive energy flow.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x108,
        (
            "#072FYes...as if the air were charged,\x01",
            "somehow.\x02",
        )
    )
    ...
    ChrTalk(    #6
        0x104,
        "#032FIt's like...the flow of orbal energy...\x02",
    )
    ...
    ChrTalk(    #7
        0x102,
        (
            "#015FThis is probably our last stop.\x02\x03",

            "#012FLet's go over everything and\x01",
            "make sure we're ready before\x01",
            "we go inside.\x02",
        )
    )
