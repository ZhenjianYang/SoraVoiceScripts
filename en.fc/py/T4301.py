...
def main():
    ...
    ChrTalk(    #2
        0x102,
        (
            "#012FIt seems pretty solid, and the locking\x01",
    ...
    ChrTalk(    #3
        0x108,
        (
            "#072FHm... I guess we'll have to\x01",
    ...
    AnonymousTalk(    #5
        "\x07\x00Used \x07\x02Spare Key\x07\x00.\x02",
    )
    ...
    ChrTalk(    #9
        0x101,
        (
            "#007F*sigh*... Not fun.\x01",
            "Attacked out of nowhere.\x02",
        )
    )
    ...
    ChrTalk(    #10
        0x102,
        (
            "#012FIt looks like there's still quite\x01",
            "a few soldiers in the villa.\x02\x03",

            "They're patrolling the corridor in\x01",
            "the central courtyard periodically. \x02",
        )
    )
    ...
    ChrTalk(    #11
        0x108,
        (
            "#072FOur only option will be to\x01",
            "silence anyone who sees us.\x02",
        )
    )
    ...
    ChrTalk(    #15
        ...
        (
            "#012FIt looks like there's still quite\x01",
            "a few soldiers in the castle.\x02\x03",
