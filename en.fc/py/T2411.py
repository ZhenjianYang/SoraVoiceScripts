...
def main():
    ...
    ChrTalk(    #5
        0xC,
        (
            "#774F#4PWha... I didn't do anything!\x02\x03",
    ...
    ChrTalk(    #6
        0xA,
        "#3PClem's still half-asleep.\x02",
    )
    ...
    ChrTalk(    #9
        0x9,
        (
            "#2PWhat's goin' on, Matron Theresa?\x01",
            "I'm kinda scared...\x02",
        )
    )
    ...
    ChrTalk(    #10
        0x8,
        "#752FThere's a fire! Everyone up!\x02",
    )
    ...
    ChrTalk(    #13
        0x8,
        (
            "#755FWe're going downstairs now!\x02\x03",

            "Everyone stay close to me!\x02",
        )
    )
    ...
    ChrTalk(    #15
        0xA,
        "*cough* *cough*...It's all smoky!\x02",
    )
    ...
    ChrTalk(    #18
        0x8,
        "#755FCome on, hurry to the exit!\x02",
    )
    ...
    ChrTalk(    #21
        ...
        (
            ...
            "Great Aidios! I don't care about\x01",
            "me, but protect the children...\x02",
        )
    )
