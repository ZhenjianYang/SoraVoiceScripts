...
def main():
    ...
    AnonymousTalk(    #1
        "\x07\x00Found \x07\x02Tin Staff\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "\x07\x00Found \x07\x02Tin Staff\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Tin Staff\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        "\x07\x05Apparently someone already looted this chest. Now who could that be...?\x07\x00\x02",
    )
    ...
    AnonymousTalk(    #4
        "\x07\x00Found \x07\x02Potluck in a Shell\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #5
        (
            "\x07\x00Found \x07\x02Potluck in a Shell\x07\x00 in chest.\x01",
            "Inventory full so gave up \x07\x02Potluck in a Shell\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #6
        (
            "\x07\x05I'd ask yourself how long that Potluck has\x01",
            "been in this chest and if you feel lucky.\x07\x00\x02",
        )
    )
