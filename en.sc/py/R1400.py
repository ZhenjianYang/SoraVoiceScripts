...
def main():
    ...
    OP_EA(0x2, 0xD0, 0x1, 0x0)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x368, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_38C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x1E)
    OP_73(0x0)
    OP_6F(0x0, 30)
    ...
    AnonymousTalk(    #1
        "\x07\x05<ECHOOOOOOOOOOOOOOO>\x02",
    )
    ...
    def Function_4_3BA(): pass

    label("Function_4_3BA")

    OP_EA(0x2, 0xD1, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x368, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_492")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_42B")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_5_52C(): pass

    label("Function_5_52C")

    OP_EA(0x2, 0xD2, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x368, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_604")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_59D")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_683(): pass

    label("Function_6_683")
    ...
    AnonymousTalk(    #8
        (
            "\x07\x05North: City of Bose\x01",
            "South: Valleria Shore - 200 selge\x02",
        )
    )
