...
def main():
    ...
    def Function_7_100B(): pass

    label("Function_7_100B")

    TalkBegin(0xFE)

    ChrTalk(    #35
        0xFE,
        "#5S元に戻すときはデフォルト座標を指定しよう。\x02",
    )
