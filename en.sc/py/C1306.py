...
def main():
    ...
    AnonymousTalk(    #2
        "\x07\x05Wow, could you at least ASK before opening me?\x07\x00\x02",
    )
    ...
    OP_EA(0x2, 0x51, 0x0, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x320, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_468")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FE, 1)"), scpexpr(EXPR_END)), "loc_401")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    OP_EA(0x2, 0x52, 0x0, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x320, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_58C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FB, 1)"), scpexpr(EXPR_END)), "loc_525")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_613(): pass

    label("Function_6_613")
    ...
    ChrTalk(    #11
        0x102,
        (
            "#1030F#6P(Kyle. Hand me one of those S2 bombs\x01",
            "I gave you. Quickly.)\x02",
        )
    )
