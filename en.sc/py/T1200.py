...
def main():
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2E3")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2F2")
    EventEnd(0x1)
    ...
    def Function_5_2F7(): pass

    label("Function_5_2F7")
    ...
    def Function_6_2FB(): pass

    label("Function_6_2FB")
