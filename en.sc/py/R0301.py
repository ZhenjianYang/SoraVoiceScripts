...
def main():
    ...
    def Function_3_424(): pass

    label("Function_3_424")
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05South: City of Rolent - 126 selge\x01",
            "North: Malga Mine - 123 selge\x09\x02",
        )
    )
    ...
    AnonymousTalk(    #4
        (
            "\x07\x05West: Esmelas Tower - 53 selge\x01",
