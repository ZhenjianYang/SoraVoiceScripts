...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_9E1",          # 08, 8
        "Function_9_A0A",          # 09, 9
        "Function_10_C5A",         # 0A, 10
        "Function_11_DA7",         # 0B, 11
        "Function_12_EC4",         # 0C, 12
        "Function_13_1017",        # 0D, 13
        "Function_14_11A3",        # 0E, 14
        "Function_15_12DE",        # 0F, 15
    )
    ...
    OP_EA(0x2, 0x23, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BA5")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x6, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AF4")
    ...
    QueueWorkItem(0x8, 1, lambda_A61)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x18A, 1)"), scpexpr(EXPR_END)), "loc_B40")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)

    AnonymousTalk(    #1
        "Found \x1F\x8A\x01\x07\x00.\x02",
    )
    ...
    AnonymousTalk(    #2
        (
            "Found \x1F\x8A\x01\x07\x00 in chest.\x01",
            "Inventory full so gave up \x1F\x8A\x01\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05Thinking you've come back to return its stuff,\x01",
            "the chest opens wide in anticipation. As you\x01",
            "leave, it closes with a pained, awkward creak.\x07\x00\x02",
        )
    )
    ...
    def Function_10_C5A(): pass

    label("Function_10_C5A")

    OP_EA(0x2, 0x24, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D32")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x7, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F7, 1)"), scpexpr(EXPR_END)), "loc_CCB")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #6
        (
            "\x07\x05Running your hands along the bottom of the\x01",
            "chest, you obtain a splinter!\x07\x00\x02",
        )
    )
    ...
    def Function_11_DA7(): pass

    label("Function_11_DA7")

    OP_EA(0x2, 0x25, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E7F")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x8, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FF, 1)"), scpexpr(EXPR_END)), "loc_E18")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_12_EC4(): pass

    label("Function_12_EC4")

    OP_EA(0x2, 0x26, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F9C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x9, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x140, 1)"), scpexpr(EXPR_END)), "loc_F35")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #12
        (
            "\x07\x05As you turn away from the empty chest, you hear\x01",
            "a strange and ominous hissing.\x07\x00\x02",
        )
    )
    ...
    def Function_13_1017(): pass

    label("Function_13_1017")

    OP_EA(0x2, 0x27, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x469, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_10EF")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xA, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FB, 1)"), scpexpr(EXPR_END)), "loc_1088")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    # Function_13_1017 end

    def Function_14_11A3(): pass

    label("Function_14_11A3")

    OP_EA(0x2, 0x28, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46A, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_127B")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xB, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x206, 1)"), scpexpr(EXPR_END)), "loc_1214")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    # Function_14_11A3 end

    def Function_15_12DE(): pass

    label("Function_15_12DE")

    OP_EA(0x2, 0x29, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46A, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_13B6")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xC, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x295, 1)"), scpexpr(EXPR_END)), "loc_134F")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #20
        (
            "Found \x1F\x95\x02\x07\x00 in chest.\x01",
            "Inventory full so gave up \x1F\x95\x02\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #21
        (
            "\x07\x05The chest is empty. You're struck by the urge\x01",
            "to climb inside and take a nap.\x07\x00\x02",
        )
    )
