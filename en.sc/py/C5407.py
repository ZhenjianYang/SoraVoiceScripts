...
def main():
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05Access to the Sanctuary and the engine\x01",
            "room is restricted.\x02",
        )
    )
    ...
    AnonymousTalk(    #1
        "\x07\x05Please provide voice identification.\x02",
    )
    ...
    ChrTalk(    #2
        0x8,
        (
            "#263F#6PEnforcer No. XV, Renne.\x01",
            "Codename: Angel of Slaughter.\x02\x03",

            "Destination, Sanctuary.\x02",
        )
    )
    ...
    QueueWorkItem(0xFE, 2, lambda_2F3)
    ...
    def Function_4_328(): pass

    label("Function_4_328")
    ...
    QueueWorkItem(0xFE, 2, lambda_34F)
    ...
    def Function_5_377(): pass

    label("Function_5_377")
    ...
    FadeToBright(1000, 0)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 1)), scpexpr(EXPR_END)), "loc_41B")
    Call(0, 7)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 2)), scpexpr(EXPR_END)), "loc_432")
    Call(0, 6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 3)), scpexpr(EXPR_END)), "loc_449")
    Call(0, 7)
    NewScene("ED6_DT21/C5400   ._SN", 125, 0, 0)
    IdleLoop()
    Jump("loc_4B9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 4)), scpexpr(EXPR_END)), "loc_460")
    Call(0, 6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 5)), scpexpr(EXPR_END)), "loc_477")
    Call(0, 7)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 6)), scpexpr(EXPR_END)), "loc_48E")
    Call(0, 6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x390, 7)), scpexpr(EXPR_END)), "loc_4A5")
    Call(0, 7)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x391, 0)), scpexpr(EXPR_END)), "loc_4B9")
    Call(0, 6)
    ...
    def Function_6_4BA(): pass

    label("Function_6_4BA")
