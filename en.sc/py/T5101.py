...
def main():
    ...
    ChrTalk(    #0
        0x8,
        (
            "#841FThat concludes today's training.\x02\x03",

            "You did well, you two.\x01",
            "You must be tired, I imagine.\x02",
        )
    )
    ...
    ChrTalk(    #2
        0x10A,
        (
            "#813F#6PI'll say... Feels like my legs are gonna fall off.\x01",
            "That was the hardest thing we've done here!\x02",
        )
    )
    ...
    ChrTalk(    #3
        0x8,
        (
            "#843FWe still need to work on\x01",
            "your endurance a bit, perhaps.\x02\x03",

            "#840FWell, be sure to get some rest this\x01",
            "evening. We have quite a day tomorrow.\x02",
        )
    )
    ...
    ChrTalk(    #5
        0x10A,
        "#1316F#6PSee you in a bit, Kurt.\x02",
    )
    ...
    def Function_3_4BE(): pass

    label("Function_3_4BE")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x203, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_574")
    EventBegin(0x1)

    ChrTalk(    #6
        0x101,
        (
            "#1007FPhew! Man, today's training\x01",
            "was rough.\x02\x03",

            "#1011FAt least I'm already done for\x01",
            "the day. I should probably get\x01",
            "some rest while I can.\x02",
        )
    )
