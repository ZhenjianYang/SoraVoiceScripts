...
def main():
    ...
    BuildStringList(
        '@FileName',                            # 8
        'Industrial Block 1 - Factoria',        # 9
        'Industrial Block 3 - Factoria',        # 10
        '',                                     # 11
        '',                                     # 12
        '',                                     # 13
    )
    ...
    QueueWorkItem(0x101, 1, lambda_2B0)
    OP_6C(315000, 7000)
    Fade(500)
    ...
    def Function_5_454(): pass

    label("Function_5_454")
    ...
    QueueWorkItem(0x101, 2, lambda_528)
