...
def main():
    ...
    BuildStringList(
        ...
        'Soldier',                              # 11
        'Soldier',                              # 12
        'West Bose Highway',                    # 13
        'East Bose Highway',                    # 14
        'Bose - South Block',                   # 15
        'Bose International Port',              # 16
    )
    ...
    ScpFunction(
        ...
        "Function_8_687",          # 08, 8
        "Function_9_68B",          # 09, 9
        "Function_10_68F",         # 0A, 10
        "Function_11_693",         # 0B, 11
    )
    ...
    QueueWorkItem(0x101, 3, lambda_5D0)
    FadeToBright(1000, 0)
    Sleep(2000)
    Sleep(2000)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 0, lambda_60A)

    def lambda_622():
        OP_67(0, 7200, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_622)

    def lambda_63A():
        OP_6B(4410, 8000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_63A)

    def lambda_64A():
        OP_6E(211, 8000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_64A)
    ...
    def Function_4_677(): pass

    label("Function_4_677")
    ...
    def Function_7_683(): pass

    label("Function_7_683")
    ...
    def Function_8_687(): pass

    label("Function_8_687")
    ...
    def Function_9_68B(): pass

    label("Function_9_68B")
    ...
    def Function_10_68F(): pass

    label("Function_10_68F")
    ...
    def Function_11_693(): pass

    label("Function_11_693")
