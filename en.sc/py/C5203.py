...
def main():
    ...
    AnonymousTalk(    #1
        (
            "Found \x1F\x89\x01\x07\x00 in chest.\x01",
            "Inventory full so gave up \x1F\x89\x01\x07\x00.\x02",
        )
    )
    ...
    OP_EA(0x2, 0x17, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x463, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AEC")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xA, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xA6, 1)"), scpexpr(EXPR_END)), "loc_A85")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #4
        (
            "Found \x1F\xA6\x00\x07\x00 in chest.\x01",
            "Inventory full so gave up \x1F\xA6\x00\x07\x00.\x02",
        )
    )
    ...
    OP_EA(0x2, 0x18, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x463, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C78")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xB, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FD, 1)"), scpexpr(EXPR_END)), "loc_C11")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    OP_EA(0x2, 0x19, 0x1, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x463, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DB9")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0xC, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x2A3, 1)"), scpexpr(EXPR_END)), "loc_D52")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    AnonymousTalk(    #10
        (
            "Found \x1F\xA3\x02\x07\x00 in chest.\x01",
            "Inventory full so gave up \x1F\xA3\x02\x07\x00.\x02",
        )
    )
    ...
    AnonymousTalk(    #11
        (
            "\x07\x05The chest is empty, but the woodwork is\x01",
            "impressive!\x07\x00\x02",
        )
    )
