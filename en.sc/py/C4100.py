...
def main():
    ...
    OP_EA(0x2, 0xF8, 0x0, 0x0)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x2E0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_441")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x1E)
    OP_73(0x3)
    OP_6F(0x3, 30)
    ...
    AnonymousTalk(    #1
        (
            "\x07\x05As payment for taking my stuff, you must cut down\x01",
            "the tallest tree in the forest...with...A HERRING!\x02",
        )
    )
    ...
    OP_EA(0x2, 0xF9, 0x0, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x2E0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_597")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_530")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
