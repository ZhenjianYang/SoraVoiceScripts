...
def main():
    ...
    OP_16(0x2, 0xFA0, 0xFFFE0048, 0xFFFE13D0, 0x230034)
    Return()
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_21B")
    ...
    def Function_3_21C(): pass

    label("Function_3_21C")
    ...
    AnonymousTalk(    #0
        (
            "\x07\x05West: City of Zeiss - 221 selge\x01",
            "East: Sanktheim Gate\x02",
        )
    )
