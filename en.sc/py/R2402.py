...
def main():
    ...
    AnonymousTalk(    #2
        (
            "\x07\x05You've seen a lot of empty chests\x01",
            "chests in your day, but you've really\x01",
            "gotta say, this one's the finest.\x07\x00\x02",
        )
    )
