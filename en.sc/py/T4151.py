...
def main():
    ...
    BuildStringList(
        '@FileName',                            # 8
        'Grancel - North Block',                # 9
        'Grancel - South Block',                # 10
        'Grancel Landing Port',                 # 11
    )
    ...
    def Function_3_2EF(): pass

    label("Function_3_2EF")
    ...
    def Function_7_2FF(): pass

    label("Function_7_2FF")
