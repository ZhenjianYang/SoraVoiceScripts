...
def main():
    ...
    OP_EA(0x2, 0x3, 0x2, 0x0)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x262, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_372")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x262, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2C1")
    ...
    QueueWorkItem(0x8, 1, lambda_22E)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x142, 1)"), scpexpr(EXPR_END)), "loc_30D")
    ...
    AnonymousTalk(    #3
        (
            "\x07\x05What happens when you clear out every chest\x01",
            "in the world? What will OTHER adventurers do\x01",
            "then?\x07\x00\x02",
        )
    )
